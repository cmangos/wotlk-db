...
UPDATE quest_template SET RequiredRaces = 512 WHERE entry IN (9532, 9460, 9618);
...
UPDATE quest_template SET RequiredRaces = 512 WHERE entry IN (8328, 8563, 8564, 9392, 9393, 9676);
