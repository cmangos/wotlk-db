...
(10026,2,0,0,0,0,2000001379,0,0,0,0,0,0,'Pathaleon the Calculator\'s Image - I believe I may recognize them.  Deal with this quickly, Sharth.  Then take the mana bomb and destroy their town!',0,0,0,0),
...
(1855401,2,0,0,0,0,2000001370,0,0,0,0,0,0,'Sharth Voldoun - My master, we are honored by your presence.  How may I serve thee?',0,0,0,0),
...
(1855402,1,0,0,0,0,2000001371,0,0,0,21504,10,0,'Pathaleon the Calculator\'s Image - Rise, young Voldoun.  Do not worry yourself with pleasantries.  I come at the behest of our master, Prince Kael\'thas.  He bids me to check on the progress of the mana bomb.',0,0,0,0),
...
(1855403,1,0,0,0,0,2000001372,0,0,0,0,0,0,'Sharth Voldoun - All goes exceedingly well, my lord.  Testing of the smaller prototype at the Cenarion Thicket was a complete success.  The second bomb is being ritually fueled in the courtyard below even as we speak.  And, I\'ve sent...',0,0,0,0),
...
(1855404,1,0,0,0,0,2000001373,0,0,0,0,0,0,'Sharth Voldoun - You are satisfied?',0,0,0,0),
...
(1855405,1,0,0,0,0,2000001374,0,0,0,21504,10,0,'Pathaleon the Calculator\'s Image - For the time being, yes.  However, allow my presence to be a motivator.  Prince Kael\'thas was displeased with the failure of the crystal experiment on Fallen Sky Ridge.  This is...',0,0,0,0),
...
(1855406,1,0,0,0,0,2000001375,0,0,0,21504,10,0,'Pathaleon the Calculator\'s Image - I need not tell you what will happen should the mana bomb down in the courtyard fail to be used on its target soon?  Since moving into the forest, they\'ve become increasingly...',0,0,0,0),
...
(1855407,1,0,0,0,0,2000001376,0,0,0,21504,10,0,'Pathaleon the Calculator\'s Image - I think that we should teach a lesson to both the Horde and the Alliance.  One that they will not soon forget!',0,0,0,0),
...
(1855408,1,0,0,0,0,2000001377,0,0,0,0,0,0,'Sharth Voldoun - I can assure you that we will not fail, my master.  I am personally overseeing every aspect of the construction, and I hold the final codes, myself.  Within a day\'s time, I will have the bomb detonated on those nearby pests.',0,0,0,0),
...
(1855409,1,0,0,0,0,2000001378,0,0,0,21504,10,0,'Pathaleon the Calculator\'s Image - See to it that you do, Sharth, or I will personally see to your slow torture and death.',0,0,0,0),
...
DELETE FROM dbscript_string WHERE entry BETWEEN 2000001370 AND 2000001379;
...
(2000001370, 'My master, we are honored by your presence.  How may I serve thee?', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'Sharth Voldoun (Entry: 18554)'),
(2000001371, 'Rise, young Voldoun.  Do not worry yourself with pleasantries.  I come at the behest of our master, Prince Kael\'thas.  He bids me to check on the progress of the mana bomb.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1, 'Pathaleon the Calculator\'s Image (Entry: 21504)'),
(2000001372, 'All goes exceedingly well, my lord.  Testing of the smaller prototype at the Cenarion Thicket was a complete success.  The second bomb is being ritually fueled in the courtyard below even as we speak.  And, I\'ve sent a courier to Tuurem to bring the rest of the parts to us here.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1, 'Sharth Voldoun (Entry: 18554)'),
(2000001373, 'You are satisfied?', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 6, 'Sharth Voldoun (Entry: 18554)'),
(2000001374, 'For the time being, yes.  However, allow my presence to be a motivator.  Prince Kael\'thas was displeased with the failure of the crystal experiment on Fallen Sky Ridge.  This is one of the reasons for why we chose the Cenarion druids as the testing grounds for the bomb.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1, 'Pathaleon the Calculator\'s Image (Entry: 21504)'),
(2000001375, 'I need not tell you what will happen should the mana bomb down in the courtyard fail to be used on its target soon?  Since moving into the forest, they\'ve become increasingly annoying to our operations: here, at Tuurem and to the south at the Bonechewer Ruins.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1, 'Pathaleon the Calculator\'s Image (Entry: 21504)'),
(2000001376, 'I think that we should teach a lesson to both the Horde and the Alliance.  One that they will not soon forget!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 5, 'Pathaleon the Calculator\'s Image (Entry: 21504)'),
...
(2000001378, 'See to it that you do, Sharth, or I will personally see to your slow torture and death.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 25, 'Pathaleon the Calculator\'s Image (Entry: 21504)'),
(2000001379, 'I believe I may recognize them.  Deal with this quickly, Sharth.  Then take the mana bomb and destroy their town!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 5, 'Pathaleon the Calculator\'s Image (Entry: 21504)');
