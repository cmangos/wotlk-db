...
UPDATE `creature` SET `position_x` = '-4053.16455078125', `position_y` = '-2354.985107421875', `position_z` = '126.2137374877929687', `orientation` = '5.252184867858886718', `spawndist` = '3', `MovementType` = '1' WHERE (`guid` = '13674');
