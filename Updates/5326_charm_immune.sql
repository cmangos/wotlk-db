...
UPDATE creature_template SET MechanicImmuneMask=MechanicImmuneMask|1 WHERE entry IN(23940,26844,24218,24152,24238,27579,28373,29885,29375,29503,27334,27762,27210,26926,26828,26180,25392,26158,25804,25605,27108,27106,27107,27110);
