-- Shattrath City - Dungeon Daily images
...
-- Daily Dungeons
(@GUID := @GUID + 0,24434,530,1,0,0,-1803.635,5143.491,-39.2503,2.19344,300,300,0,0,6986,0,0,0),     -- Arcatraz Sentinel Image
(@GUID := @GUID + 1,24415,530,1,0,0,-1803.635,5143.491,-39.2503,2.19344,300,300,0,0,6986,0,0,0),     -- Coilfang Myrmidon Image
(@GUID := @GUID + 1,24426,530,1,0,0,-1803.635,5143.491,-39.2503,2.19344,300,300,0,0,5589,3155,0,0),  -- Malicious Instructor Image
(@GUID := @GUID + 1,24429,530,1,0,0,-1803.635,5143.491,-39.2503,2.19344,300,300,0,0,7181,0,0,0),     -- Rift Lord Image
(@GUID := @GUID + 1,24411,530,1,0,0,-1803.635,5143.491,-39.2503,2.19344,300,300,0,0,6986,0,0,0),     -- Shattered Hand Centurion Image
(@GUID := @GUID + 1,24430,530,1,0,0,-1803.635,5143.491,-39.2503,2.19344,300,300,0,0,6986,7196,0,0),  -- Sunseeker Channeler Image
(@GUID := @GUID + 1,24432,530,1,0,0,-1803.635,5143.491,-39.2503,2.19344,300,300,0,0,6986,0,0,0),     -- Tempest-Forge Destroyer Image
(@GUID := @GUID + 1,24854,530,1,0,0,-1803.635,5143.491,-39.2503,2.19344,300,300,0,0,5589,3155,0,0),  -- Sister of Torment Image
-- Daily Heroics
(@GUID := @GUID + 1,24410,530,1,0,0,-1787.656,5158.583,-39.02167,3.12,300,300,0,0,7380,0,0,0),     	-- Vazruden the Herald Image
(@GUID := @GUID + 1,24420,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,5903,3309,0,0),   	-- The Black Stalker Image
(@GUID := @GUID + 1,24431,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,7380,0,0,0),      	-- Warp Splinter Image
(@GUID := @GUID + 1,24428,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,7380,0,0,0),      	-- Aeonus Image
(@GUID := @GUID + 1,24414,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,7380,0,0,0),      	-- Warchief Kargath Bladefist Image
(@GUID := @GUID + 1,24413,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,7380,7500,0,0),    -- Keli'dan the Breaker Image
(@GUID := @GUID + 1,24425,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,7380,0,0,0),      	-- Murmur Image
(@GUID := @GUID + 1,24433,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,5903,3309,0,0),   	-- Pathaleon the Calculator's Image
(@GUID := @GUID + 1,24423,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,5903,3309,0,0),   	-- Nexus-Prince Shaffar Image
(@GUID := @GUID + 1,24427,530,1,0,0,-1787.656,5158.583,-39.02167,3.12,300,300,0,0,7380,0,0,0),     	-- Epoch Hunter Image
(@GUID := @GUID + 1,24424,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,7380,3309,0,0),    -- Exarch Maladaar Image
(@GUID := @GUID + 1,24422,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,5166,7500,0,0),   	-- Talon King Ikiss Image
(@GUID := @GUID + 1,24419,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,7380,0,0,0),      	-- Quagmirran Image
(@GUID := @GUID + 1,24435,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,5903,3309,0,0),   	-- Harbinger Skyriss Image
(@GUID := @GUID + 1,24421,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,42,0,0,0),        	-- Warlord Kalithresh Image
(@GUID := @GUID + 1,24855,530,1,0,0,-1787.656,5158.583,-39.2503,3.12,300,300,0,0,5903,3309,0,0);   	-- Kael'thas Sunstrider Image
