...
UPDATE `creature_template` SET `UnitFlags` = 64, `MeleeBaseAttackTime` = 2000, `EquipmentTemplateId` = 2356 WHERE `entry` = 21563;

-- Nethervine Reaper 19512,21564
UPDATE `creature_template` SET `UnitFlags` = 64, `MovementType` = 0 WHERE `entry` = 19512;
UPDATE `creature_template` SET `UnitFlags` = 64, `EquipmentTemplateId` = 1583  WHERE `entry` = 21564;
