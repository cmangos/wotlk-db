...
DELETE FROM creature_addon WHERE guid IN (141075);
DELETE FROM creature_movement WHERE id IN (141075);
DELETE FROM creature_linking WHERE guid IN (141075);
DELETE FROM creature_linking WHERE master_guid IN (141075);
DELETE FROM creature WHERE guid IN (141075);
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
(141075,29393,571,1,1,0,0,2851.36,-3863.74,248.53,5.305801,300,300,0,0,13945,0,0,0);
-- Update
...
(2939401,17,15,42811,0,0,29393,141075,1 | 0x10,0,0,0,0,0,0,0,0,''),
...
(2939401,22,15,34427,0,0,29393,141075,7 | 0x10,0,0,0,0,0,0,0,0,'');
...
(20067,0,15,5,0,0,24014,141071,7 | 0x10,0,0,0,0,0,0,0,0,''), -- should be 3617 (missing sereverside)
(20067,0,15,5,0,0,24014,141072,7 | 0x10,0,0,0,0,0,0,0,0,''), -- should be 3617 (missing sereverside)
(20067,0,15,5,0,0,24014,141073,7 | 0x10,0,0,0,0,0,0,0,0,''), -- should be 3617 (missing sereverside)
