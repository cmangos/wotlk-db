...
-- Add texts
DELETE FROM `dbscript_string` WHERE `entry` BETWEEN 2000019033 AND 2000019047;
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`, `comment`, `broadcast_text_id`) VALUES 
(2000019033, 'Woot!  Here we go!', 0, 0, 0, 0, 'Boots (Entry: 19617)',17062),
(2000019034, 'Uh oh!', 0, 0, 0, 0, 'Boots (Entry: 19617)',17063),
(2000019035, 'I''m ok, I''m ok!  Ah well, back to the drawing board on that rocket fuel!', 0, 0, 0, 1, 'Boots (Entry: 19617)',17064),
(2000019036, 'Thanks...', 0, 0, 0, 0, 'Boots (Entry: 19617)',17082),

(2000019037, 'Yikes!  Someone call the fire marshal!  Medic!!!  Is there a doctor in the house?', 0, 0, 0, 5, 'Off-Duty Engineer (Entry: 19780)',17067),

(2000019038, 'I''m a doctor!  What seems to be the problem?', 0, 0, 0, 1, 'Doc (Entry: 19623)',17071),
(2000019039, 'Oh!  Someone needs to get those fires out so I can get in there and save that goblin!', 0, 0, 0, 5, 'Doc (Entry: 19623)',17072),
(2000019040, 'Right... let me in there!', 0, 0, 0, 0, 'Doc (Entry: 19623)',17074),
(2000019041, 'Everyone clear!', 0, 0, 0, 0, 'Doc (Entry: 19623)',17076),
(2000019042, 'Come on!  Clear!', 0, 0, 0, 0, 'Doc (Entry: 19623)',17077),
(2000019043, 'Dammit, Boots, I''m a doctor not a priest!  Clear!!!', 0, 0, 0, 0, 'Doc (Entry: 19623)',17078),
(2000019044, 'I''ve got a pulse!', 0, 0, 0, 0, 'Doc (Entry: 19623)',17079),

(2000019045, 'Someone called?', 0, 0, 0, 0, 'Bill (Entry: 19621)',17084),

(2000019046, 'Daddy!', 0, 0, 0, 0, 'Nadja (Entry: 22279)',20062),

(2000019047, 'Dad!', 0, 0, 0, 0, 'Soren (Entry: 22280)',20063);
...
(10199,9062,0,0,0,0,0,2000019033,0,0,0,0,0,0,'Boots - Woot!  Here we go!',0,0,0,0),
...
(10199,19984,0,0,0,0,0,2000019034,0,0,0,0,0,0,'Boots - Uh oh!',0,0,0,0),
...
(10199,92844,0,0,0,0,0,2000019035,0,0,0,0,0,0,'Boots - I''m ok, I''m ok!  Ah well, back to the drawing board on that rocket fuel!',0,0,0,0),
(10199,99031,0,0,0,0,0,2000019036,0,0,0,0,0,0,'Boots - Thanks...',0,0,0,0),
...
(10199,21094,0,0,0,0,0,2000019037,0,0,0,19780,10,0,'Off-Duty Engineer - Yikes!  Someone call the fire marshal!  Medic!!!  Is there a doctor in the house?',0,0,0,0),
...
-- Doc 19623
(10199,24859,0,0,0,0,0,2000019038,0,0,0,19623,12,0,'Doc - I''m a doctor!  What seems to be the problem?',0,0,0,0),
(10199,28391,0,36,0,0,0,0,0,0,0,19623,12,3,'Doc - Face Boots',0,0,0,0),
(10199,29719,0,0,0,0,0,2000019039,0,0,0,19623,12,0,'Doc - Oh!  Someone needs to get those fires out so I can get in there and save that goblin!',0,0,0,0),
(10199,49203,0,0,0,0,0,2000019040,0,0,0,19623,12,0,'Doc - Right... let me in there!',0,0,0,0),
...
(10199,54047,0,0,0,0,0,2000019041,0,0,0,19623,5,0,'Doc - Everyone clear!',0,0,0,0),
(10199,57578,0,15,34332,0,0,0,0,0,0,19623,5,7,'Doc - Cast Defibrillate',0,0,0,0),
(10199,66203,0,0,0,0,0,2000019042,0,0,0,19623,5,0,'Doc - Come on!  Clear!',0,0,0,0),
(10199,69703,0,15,34332,0,0,0,0,0,0,19623,5,7,'Doc - Cast Defibrillate',0,0,0,0),
(10199,74703,0,0,0,0,0,2000019043,0,0,0,19623,5,0,'Doc - Dammit, Boots, I''m a doctor not a priest!  Clear!!!',0,0,0,0),
(10199,79437,0,15,34332,0,0,0,0,0,0,19623,5,7,'Doc - Cast Defibrillate',0,0,0,0),
(10199,90516,0,0,0,0,0,2000019044,0,0,0,19623,5,0,'Doc - I''ve got a pulse!',0,0,0,0),
...
(10199,39859,0,0,0,0,0,2000019045,0,0,0,19621,6,0,'Bill - Someone called?',0,0,0,0),
...
(10199,20375,0,0,0,0,0,2000019046,0,0,0,22279,40,0,'Nadja - Daddy!',0,0,0,0),
(10199,20375,0,0,0,0,0,2000019047,0,0,0,22280,40,0,'Soren - Dad!',0,0,0,0),
...
(10199,41781,0,40,0,0,0,0,0,0,0,183796,161347,23,'Despawn Fire 1',0,0,0,0),
(10199,44203,0,40,0,0,0,0,0,0,0,183796,161348,23,'Despawn Fire 2',0,0,0,0),
(10199,47844,0,40,0,0,0,0,0,0,0,183796,161349,23,'Despawn Fire 3',0,0,0,0),

(10199,98094,0,40,0,0,0,0,0,0,0,183797,161350,23,'Despawn Smoke 1',0,0,0,0),
(10199,99234,0,40,0,0,0,0,0,0,0,183797,161351,23,'Despawn Smoke 2',0,0,0,0),
(10199,99234,0,40,0,0,0,0,0,0,0,183797,161352,23,'Despawn Smoke 3',0,0,0,0),
(10199,99234,0,40,0,0,0,0,0,0,0,183797,161353,23,'Despawn Smoke 4',0,0,0,0);
