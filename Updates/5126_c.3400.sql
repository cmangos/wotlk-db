...
UPDATE npc_vendor SET Slot = 2 WHERE entry = 3400 AND item = 21099; -- Recipe: Smoked Sagefish
UPDATE npc_vendor SET Slot = 3 WHERE entry = 3400 AND item = 21219; -- Recipe: Sagefish Delight
