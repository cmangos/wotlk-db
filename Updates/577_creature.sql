...
(119583,2453,0,1,1,0,0,896.904,-547.316,142.524,3.53498,7200,0,0,1196,3075,0,0);
-- Death Howl - Pooling
DELETE FROM pool_creature_template WHERE id = 2453;
INSERT INTO pool_creature_template (id, pool_entry, chance, description) VALUES
(2453, 25564, 0, 'Alterac Mountains - Lo\'Grosh (Rare)');
DELETE FROM pool_template WHERE entry = 25564;
