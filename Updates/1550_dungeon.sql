...
UPDATE creature_template SET MovementType=1, EquipmentTemplateId=1486 WHERE entry IN (18053);
...
UPDATE creature_template SET MovementType=1, EquipmentTemplateId=1487 WHERE entry IN (18054);
...
UPDATE creature_template SET MovementType=1, EquipmentTemplateId=572 WHERE entry IN (18049);

-- Bleeding Hollow Archer (17270 / 18048)
UPDATE creature_template SET MovementType=1, EquipmentTemplateId=1488 WHERE entry IN (18048);
...
UPDATE creature_template SET MovementType=1, EquipmentTemplateId=315 WHERE entry IN (18052);
...
('17280','543','17455','4352','50'); -- Shattered Hand Warhound will Despawn on Nearby Bonechewer Beastmaster Evade
...
UPDATE creature_template SET MovementType=1, EquipmentTemplateId=310 WHERE entry IN (18058);
DELETE FROM creature_linking WHERE guid IN (62088,62089);
DELETE FROM creature_linking_template WHERE entry IN (17309);
INSERT INTO creature_linking_template (`entry`, `map`, `master_entry`, `flag`, `search_range`) VALUES
('17309','543','17306','1671','0'); -- Hellfire Watcher Respawn on Watchkeeper Gargolmar Evade
...
UPDATE creature_template SET MovementType=1, EquipmentTemplateId=293 WHERE entry IN (18057);
DELETE FROM creature_linking WHERE guid IN (63011);
DELETE FROM creature_linking_template WHERE entry IN (17517);
INSERT INTO `creature_linking_template` (`entry`, `map`, `master_entry`, `flag`, `search_range`) VALUES
('17517','543','17536','133','0'); -- Hellfire Sentry Aggro on Nazan Aggro and Respawn on Nazan Respawn/Evade 

-- Nazan (17536 / 18432)
-- UPDATE creature_template SET SkinningLootID=70065, MovementType=2 WHERE entry IN (18432);

-- Vazruden (17537 / 18434)
UPDATE creature_template SET EquipmentTemplateId = 997 WHERE entry IN (18434);
...
INSERT INTO `creature_linking_template` (`entry`, `map`, `master_entry`, `flag`, `search_range`) VALUES
('17540','543','17308','12304','0'); -- Fiendish Hound Despawns on Omor the Unscarred Death or Evade
...
('34653','0','15','31706','0','0','0','6','0','0','0','0','0','0','0','0','Nazan Normal Mode - Fireball Summons Liquid Fire');
-- Heroic
INSERT INTO `dbscripts_on_spell` (`id`, `delay`, `command`, `datalong`, `datalong2`, `buddy_entry`, `search_radius`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`) VALUES
('36920','0','15','30928','0','0','0','6','0','0','0','0','0','0','0','0','Nazan Heroic Mode - Fireball Summons Liquid Fire');
