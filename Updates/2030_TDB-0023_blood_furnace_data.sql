...
UPDATE `creature_template` SET `Faction` = 16, `UnitFlags` = 32832 WHERE `entry` IN (17429,18603);

-- Nascent Fel Orc 17398,18612
UPDATE `creature_template` SET `Faction` = 16, `UnitFlags` = 32832 WHERE `entry` IN (17398,18612);
