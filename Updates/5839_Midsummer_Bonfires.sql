...
UPDATE quest_template SET RewMoneyMaxLevel = 66300 WHERE (entry BETWEEN 11804 AND 11863) OR (entry BETWEEN 13485 AND 13500) OR (entry IN (11583, 11584));
...
UPDATE quest_template SET RewMoneyMaxLevel = 132300 WHERE (entry BETWEEN 11734 AND 11787) OR (entry BETWEEN 11799 AND 11803) OR (entry BETWEEN 13440 AND 13447) OR (entry IN (11580, 11581, 11732, 13449, 13450, 13451, 13453, 13454, 13455, 13457, 13458));
