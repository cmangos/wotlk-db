...
-- Earthroot
-- (170021,1619,0,1,1963.523,-625.2772,61.48457,0.5235979,0,0,0.2588186,0.9659259,45,90,100,1), -- .go xyz 1963.523 -625.2772 61.48457 0 -- exists in wotlkDB
-- Blood of Heroes
...
-- WotlkDB missing template 1802 - added
INSERT INTO pool_template (entry, max_limit, description) VALUES
...
-- 170043 - 170045
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170046, 990, 0, "Azshara - Purple Lotus");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170047, 990, 0, "Azshara - Dreamfoil");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170048, 990, 0, "Azshara - Golden Sansam");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170049, 990, 0, "Azshara - Purple Lotus");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170050, 990, 0, "Azshara - Golden Sansam");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170051, 990, 0, "Azshara - Khadgar's Whisker");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170052, 990, 0, "Azshara - Sungrass");
...
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170055, 990, 0, "Azshara - Stranglekelp");
-- 170056
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170057, 990, 0, "Azshara - Stranglekelp");
-- 170058
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170059, 990, 0, "Azshara - Stranglekelp");
-- 170060
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170061, 990, 0, "Azshara - Golden Sansam");
-- 170062 - 170063
-- INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
-- (170064, 990, 0, "Azshara - Golden Sansam");
-- 170065 - 170066
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170067, 990, 0, "Azshara - Purple Lotus");
-- 170068 - 170073
-- INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
-- (170074, 40037, 0, "Azshara - Solid Chest Pool");
-- INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
-- (170075, 990, 0, "Azshara - Dreamfoil");
-- INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
-- (170076, 990, 0, "Azshara - Purple Lotus");
-- INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
-- (170077, 990, 0, "Azshara - Purple Lotus");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170078, 960, 0, "Ashenvale - Mageroyal");
-- 170079
-- INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
-- (170080, 39913, 0, "Ashenvale - Battered Chest (2849)");
-- 170081 - 170087
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170088, 947, 0, "Searing Gorge - Firebloom");

-- WotlkDB missing pools
INSERT INTO pool_template (entry, max_limit, description) VALUES
(13004, 47, 'Master Herb Pool - Burning Steppes'),
(40025, 4, 'Burning Steppes - Solid Chest Pool');

-- ----------------------------------------------------------
-- dump_classic_Wow(1.13.2.31727)-11792_1568004144_parsed.txt
-- ----------------------------------------------------------
-- 2055 Master Mineral Pool - Thousand Needles
-- 964 Master Herb Pool - Feralas
...
INSERT INTO pool_template (entry, max_limit, description) VALUES
(2055, 65, "Master Mineral Pool - Thousand Needles"),
...
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170101, 964, 0, "Feralas - Stranglekelp");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170102, 242, 0, "Oily Blackmouth School");
-- INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
-- (170103, 964, 0, "Feralas - Purple Lotus");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170104, 245, 0, "Firefin Snapper School");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170105, 964, 0, "Feralas - Sungrass");
-- INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
-- (170106, 964, 0, "Feralas - Sungrass");
-- INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
-- (170107, 964, 0, "Feralas - Khadgar's Whisker");
INSERT INTO pool_gameobject (guid, pool_entry, chance, description) VALUES
(170108, 964, 0, "Feralas - Sungrass");
