...
(1265, 1, 0, 0, 0, 0, 0, 0, 0, 2000001612, 0, 0, 0, 0, 0, 0, 0, '');

DELETE FROM dbscript_string WHERE entry=2000001612;
INSERT INTO dbscript_string (entry, content_default, sound, type, emote, comment) VALUES
(2000001612,'Go with grace, and may the Lady''s magic protect you.',0,0,0,'Archmage Tervosh (4967)');
