...
-- Wotlk existing guids
DELETE FROM `gameobject` WHERE `guid` IN (4737,5047,5237,5416,20645,20646,20647,63454);
DELETE FROM `pool_gameobject` WHERE `guid` IN (4737,5047,5237,5416,20645,20646,20647,63454);
