...
UPDATE `creature_template` SET `DamageMultiplier`=4.6 WHERE `entry`=12337; -- Crimson Courier (is 1 in classic, 4.6 in wotlk)
UPDATE `creature_template` SET `DamageMultiplier`=2.4 WHERE `entry`=13118; -- Crimson Bodyguard (is 1 in classic, 2.4 in wotlk)
