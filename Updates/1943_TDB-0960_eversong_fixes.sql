...
(82891, 16247, 530, 1, 0, 0, 6439.78, -6643.51, 107.4319, 1.74359, 300, 300, 0, 0, 0, 0, 0, 0); -- free

DELETE FROM `pool_template` WHERE `entry`=46875;
INSERT INTO `pool_template` (`entry`, `max_limit`, `description`) VALUES
(46875, 1, 'Ghostlands - Borgoth the Bloodletter'); -- free

DELETE FROM `pool_creature` WHERE `guid` IN (82889,82891);
INSERT INTO `pool_creature` (`guid`, `pool_entry`, `chance`, `description`) VALUES
(82889, 46875, 0, 'Ghostlands - Borgoth the Bloodletter South'), -- existant
