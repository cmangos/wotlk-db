...
DELETE FROM `pool_creature` WHERE `pool_entry` IN (1000);
DELETE FROM `pool_template` WHERE `entry` IN (1000);
DELETE FROM `pool_creature_template` WHERE `pool_entry` IN (1000);
...
-- moved to spawn GROUPS
DELETE FROM `pool_creature` WHERE `pool_entry` IN (1001);
DELETE FROM `pool_template` WHERE `entry` IN (1001);
DELETE FROM `pool_creature_template` WHERE `pool_entry` IN (1001);
...
DELETE FROM `pool_template` WHERE `entry` IN (1265);
DELETE FROM `pool_creature_template` WHERE `pool_entry` IN (1265);
...
(11414,97,0,1,1,0,0,-10045.1,575.56,35.1568,1.24577,180,180,15,0,0,0,0,1);
-- updates
