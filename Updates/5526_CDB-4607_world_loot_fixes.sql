...
(8891, 11446, 25, 0, 1, 1, 35, 'A Crumpled Up Note'), -- Quest ID 4242 Rewarded -> hmm might need better condition!
...
(8892, 11446, 25, 0, 1, 1, 35, 'A Crumpled Up Note'), -- Quest ID 4242 Rewarded -> hmm might need better condition!
...
(50551, 8029, 0, 1, 1, 1, 10, 'Plans: Wicked Mithril Blade'), -- Has Skill ID 164, Minimum Skill Value 1 ø 8892
...
UPDATE `creature_loot_template` SET `condition_id` = 10 WHERE `item` = 8029; -- Has Skill ID 164, Minimum Skill Value 1
UPDATE `reference_loot_template` SET `condition_id` = 10 WHERE `item` = 8029;
...
UPDATE `creature_loot_template` SET `condition_id` = 11 WHERE `item` = 20976; -- Has Skill ID 755, Minimum Skill Value 1
UPDATE `reference_loot_template` SET `condition_id` = 11 WHERE `item` = 20976;
