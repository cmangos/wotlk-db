...
(1268, 0, 0, 0, 0, 0, 0, 0, 0, 0, 2000001856, 0, 0, 0, 0, 0, 0, 0, 'Krog say'),
(1268, 0, 0, 10, 4972, 100000, 0, 0, 0, 0, 1, 0, 0, 0, -3155.991, -2898.267, 33.93134, 0.501176, 'Spawn Kagaro'),
(1268, 5500, 0, 0, 0, 0, 0, 0, 0, 0, 2000001857, 0, 0, 0, 0, 0, 0, 0, 'Krog say 2'),
(1268, 7000, 0, 0, 0, 0, 0, 4972, 20, 7, 2000001858, 0, 0, 0, 0, 0, 0, 0, 'Kagoro say'),
...
-- Add texts
DELETE FROM `dbscript_string` WHERE `entry` IN (2000001856,2000001857,2000001858);
...
(2000001856, 'Kagoro, I require your presence!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 22, 1755, 'Krog (Entry: 4926)'),
(2000001857, 'Go to the Shady Rest Inn and follow the tracks. See where they lead and report back to me.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 1, 1, 1648, 'Krog (Entry: 4926)'),
(2000001858, 'Understood. I will return shortly.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 1, 1, 1649, 'Kagoro (Entry: 4972)');
