...
-- texts
DELETE FROM db_script_string WHERE entry IN (2000005024, 2000005038, 2000005050, 2000005099, 2000005100);
...
(2000005099, 'And finally the candle... to burn those who would thwart you!', 0, 0, 0, 0, 'J\'eevee say 3'),
(2000005100, '$N, my duties are complete and I shall now take my leave. Luck to you my fellow, and remember to keep the Bell, Wheel and Candle working!', 0, 0, 0, 0, 'J\'eevee say 4');
...
(8420, 23, 0, 0, 0, 14500, 50, 3, 2000005100, 0, 0, 0, 0, 'J\'eevee say 4'),
...
(1450015, 3, 0, 0, 0, 0, 0, 0, 2000005099, 'J\'eevee say 3'),
...
(8438, 1, 0, 0, 0, 14500, 40, 0, 2000005101, 0, 0, 0, 0, 'J\'eevee say 1'),
...
INSERT INTO dbscripts_on_creature_movement (id, delay, command, datalong, datalong2, buddy_entry, search_radius, data_flags, dataint, comments) VALUES
(1450002, 3, 0, 0, 0, 0, 0, 0, 2000005102, 'J''eevee say 2 on reach wp 2'),
...
-- Texts
DELETE FROM db_script_string WHERE entry IN (2000005101,2000005102,2000005178,2000005179);
INSERT INTO db_script_string (entry,content_default,sound,type,language,emote,comment) VALUES
(2000005101, 'Ah, here we are! Well let''s get to work, shall we...?', 0, 0, 0, 0, 'J\'eevee say 1 (Scholomance)'),
(2000005102, 'Oh, right! Over here now...', 0, 0, 0, 0, 'J\'eevee say 2 (Scholomance)'),
