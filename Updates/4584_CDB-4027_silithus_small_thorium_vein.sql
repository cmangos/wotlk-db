-- WotlkDB has no pools there - only static spawns
DELETE FROM `gameobject` WHERE `guid` IN (134,133,138,139,135,141,142,147,171,204,223,235,243,319,335,341,343,49322,49323,49324,49325,49326,49327,49328,49329,49330,49331);
