...
DELETE FROM `gameobject` WHERE `guid` IN (134,133,138,139,135,141,142,147,204,223,235,319,335,343,49322,49323,49324,49325,49326,49327,49328,49329,49330,49331,20264);
