...
UPDATE `creature_loot_template` SET `ChanceOrQuestChance` = 20, `condition_id` = 4 WHERE `entry` = 16408 AND `item` = 21904; -- https://www.wowhead.com/item=21904/pattern-soulcloth-vest#comments:id=106058
DELETE FROM `creature_loot_template` WHERE `entry` = 16406 AND `item` = 21903;
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`, `comments`) VALUES
(16406, 21903, 10, 0, 1, 1, 4, 'Pattern: Soulcloth Shoulders'); -- 16 mobs that can drop it in an id without resetting
