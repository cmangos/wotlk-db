...
-- UPDATE: Thrall will now send you to Overlord Runthak. (patch 3.0.2)
-- https://www.youtube.com/watch?v=g7LROdR9bUM
DELETE FROM creature_involvedrelation WHERE id = 14720 AND quest = 7784;
DELETE FROM creature_involvedrelation WHERE id = 14392 AND quest = 7784;
...
(40150, 179881, 1, 1,1,1540.28, -4422.19, 7.0051, 5.22833, 0, 0, 0.503313, -0.864104, -21600, 255, 1);
