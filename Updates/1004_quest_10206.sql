...
DELETE FROM gameobject WHERE guid = 94552;
...
(94552, 183820, 530, 3058.785, 3622.131, 143.4428, 5.951575, -0.1650467, 0.9862857, -24, -24);
...
(2175103,1,1,16,0,0,0,0,0,0,0,0,0,'Chubis - OneShotKneel',0,0,0,0),
(2175103,1,0,0,0,0,2000001244,0,0,0,0,0,0,'Chubis - This thing kind of reminds me of a Zed Power Nodule I once took half of Papa Wheeler\'s old garage out with.',0,0,0,0),
(2175103,1,9,94552,24,0,0,0,0,0,0,0,0,'Chubis - Respawn Gameobject (Ethereal Technology)',0,0,0,0),
(2175104,1,1,133,0,0,0,0,0,0,0,0,0,'Chubis - STATE_USESTANDING_NOSHEATHE',0,0,0,0),
(2175104,1,0,0,0,0,2000001245,0,0,0,0,0,0,'Chubis - The Long Tube Gadget Analyzer should tell me what I need to know.',0,0,0,0),
...
(2175105,1,0,0,0,0,2000001246,0,0,0,0,0,0,'Chubis - Ack, disintegrated!  I guess I had the power setting too high?  And it almost hit the Wheeler Mobile!  Yikes, don\'t tell him!',0,0,0,0),
(2175105,12,0,0,0,0,2000001247,0,0,0,0,0,0,'Chubis - Good thing you brought us nine others.  I think I\'ll finish this later.',0,0,0,0),
...
(10206,2,0,0,0,0,2000001243,0,0,0,21751,20,0,'Chubis - Alright, let''s see what makes this tech tick!',0,0,0,0);

DELETE FROM dbscript_string WHERE entry BETWEEN 2000001243 AND 2000001247;
INSERT INTO dbscript_string (entry, content_default, sound, type, language, emote, comment) VALUES 
(2000001243,'Alright, let\'s see what makes this tech tick!', 0, 0, 0, 0, 'Chubis (Entry: 21751)'),
(2000001244,'This thing kind of reminds me of a Zed Power Nodule I once took half of Papa Wheeler\'s old garage out with.', 0, 0, 0, 0, 'Chubis (Entry: 21751)'),
(2000001245,'The Long Tube Gadget Analyzer should tell me what I need to know.', 0, 0, 0, 0, 'Chubis (Entry: 21751)'),
(2000001246,'Ack, disintegrated!  I guess I had the power setting too high?  And it almost hit the Wheeler Mobile!  Yikes, don\'t tell him!', 0, 0, 0, 5, 'Chubis (Entry: 21751)'),
(2000001247,'Good thing you brought us nine others.  I think I\'ll finish this later.', 0, 0, 0, 1, 'Chubis (Entry: 21751)');
