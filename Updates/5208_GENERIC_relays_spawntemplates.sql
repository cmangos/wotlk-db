...
UPDATE dbscripts_on_relay SET comments = 'GENERIC - SET waypoints - Path 1' WHERE id = 20663;
UPDATE dbscripts_on_relay SET comments = 'GENERIC - SET waypoints - Path 2' WHERE id = 30602;
