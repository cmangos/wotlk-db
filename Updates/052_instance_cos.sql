...
(@DB_STRING_ENTRY+22,'Everyone I know seems to be coming down with something really bad.',0,0,0,0,'Citizen - gossip 1'),
(@DB_STRING_ENTRY+23,'Have you talked to anyone who hasn\'t started getting sick?',0,0,0,0,'Citizen - gossip 2'),
(@DB_STRING_ENTRY+24,'It must be something in the water, I tell you.',0,0,0,0,'Citizen - gossip 3'),
(@DB_STRING_ENTRY+25,'My bed is looking pretty good right now.',0,0,0,0,'Citizen - gossip 4'),
(@DB_STRING_ENTRY+26,'Prince Arthas, may the light be praised! Many people in the town have begun to fall seriously ill, can you help us?',0,0,0,0,'Citizen - query'),
(@DB_STRING_ENTRY+27,'I can only help you with a clean death.',14294,0,0,0,'Arthas - city 2'),
(@DB_STRING_ENTRY+28,'What? This can\'t be!',0,0,0,0,'Citizen - attack'),
(@DB_STRING_ENTRY+29,'Oh, no...',0,0,0,0,'Citizen - attack 2'),
(@DB_STRING_ENTRY+30,'Did you see that?',0,0,0,0,'Citizen - attack 3'),
...
(@DB_STRING_ENTRY+33,'As you can see, your people are now mine. I will now turn this city household by household, until the flame of life has been snuffed out... forever.',14411,1,0,0,'Malganis - city 5'),
