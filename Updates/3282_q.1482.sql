...
UPDATE creature_template SET Faction = 35, UnitFlags = 33555200, MinLevel = 40, MaxLevel = 40, EquipmentTemplateId = 9 WHERE entry = 5773;
-- Lord Azrethoc\'s Image 5772
UPDATE creature_template SET Faction = 90, UnitFlags = 33555200, MinLevel = 40, MaxLevel = 40, EquipmentTemplateId = 293 WHERE entry = 5772;
