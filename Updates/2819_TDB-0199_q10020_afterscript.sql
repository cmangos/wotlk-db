...
(10020,13984,0,0,0,0,0,2000019023,0,0,0,0,0,0,'Sha''nir - Drink this, Zahlia.  It is not as potent as I''d hoped, but perhaps it will help.',0,0,0,0),
...
(10020,25703,0,0,0,0,0,2000019024,0,0,0,18652,5,0,'Zahlia - I... I can see...',0,0,0,0),
...
(10020,34219,0,0,0,0,0,2000019025,0,0,0,18652,10,0,'Zahlia - I thought I''d never see my son''s face again.  Come here, Seth!  Let mom take a look at you!',0,0,0,0),
...
(10020,37875,0,0,0,0,0,2000019026,0,0,0,18653,25,0,'Seth - Don''t cry mommy.  I''m right here, see?',0,0,0,0),
(10020,60000,0,32,0,0,0,0,0,0,0,18653,10,0,'Seth - Resume Waypoints',0,0,0,0);

-- Add texts
DELETE FROM `dbscript_string` WHERE `entry` BETWEEN 2000019023 AND 2000019026;
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`, `comment`, `broadcast_text_id`) VALUES 
(2000019023, 'Drink this, Zahlia.  It is not as potent as I''d hoped, but perhaps it will help.', 0, 0, 0, 1, 'Sha''nir (Entry: 18597)',15639),
(2000019024, 'I... I can see...', 0, 0, 0, 0, 'Zahlia (Entry: 18652)',15636),
(2000019025, 'I thought I''d never see my son''s face again.  Come here, Seth!  Let mom take a look at you!', 0, 0, 0, 0, 'Zahlia (Entry: 18652)',15637),
(2000019026, 'Don''t cry mommy.  I''m right here, see?', 0, 0, 0, 0, 'Seth (Entry: 18653)',15638);
