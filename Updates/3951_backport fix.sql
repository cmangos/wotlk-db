-- Creature (GUID: 57894) does not exist but has a record in `creature_addon`
DELETE FROM creature_addon WHERE guid IN (57894);

-- mising path added
UPDATE creature SET MovementType = 2, spawndist = 0 WHERE id = 794;
