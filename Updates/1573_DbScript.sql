...
DELETE FROM dbscript_string WHERE entry=2000001668;
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`) VALUES
('2000001668', 'Another pilgrim has arrived! Bring water quickly, or we may lose her!', '0', '0', '1', '0');
...
(10028, 3, 0, 0, 0, 0, 17015, 2, 4, 2000001668, 0, 0, 0, 0, 0, 0, 0, 'Taleris - say'),
