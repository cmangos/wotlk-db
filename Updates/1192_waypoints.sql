...
UPDATE creature_template SET MovementType = 2 WHERE entry = 18976;
...
(1897601,5,0,0,0,0,2000001443,0,0,0,0,0,0,'Urga''zz - Work harder!',0,0,0,0),
(1897602,3,0,0,0,0,2000001444,0,0,0,0,0,0,'Urga''zz - Mine rock! Crack stone! Faster! Faster!',0,0,0,0);

DELETE FROM `dbscript_string` WHERE `entry` BETWEEN 2000001443 AND 2000001444;
...
(2000001443, 'Work harder!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'Urga''zz (Entry: 18976)'),
(2000001444, 'Mine rock! Crack stone! Faster! Faster!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'Urga''zz (Entry: 18976)');
