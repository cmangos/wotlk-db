...
DELETE FROM creature_addon WHERE guid IN (140986,140987);
DELETE FROM creature_movement WHERE id IN (140986,140987);
DELETE FROM game_event_creature WHERE guid IN (140986,140987);
DELETE FROM game_event_creature_data WHERE guid IN (140986,140987);
DELETE FROM creature_battleground WHERE guid IN (140986,140987);
DELETE FROM creature_linking WHERE guid IN (140986,140987)
OR master_guid IN (140986,140987);
DELETE FROM creature WHERE guid IN (140986,140987);
INSERT INTO creature (guid, id, map, spawnMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
('140986', '23115', '530', '1', '0', '0', '2337.57', '7298.993', '365.7002', '3.438299', '300', '300', '0', '0', '72539', '0', '0', '0'),
('140987', '23115', '530', '1', '0', '0', '2309.648', '7288.834', '365.8902', '0.5061455', '300', '300', '0', '0', '72539', '0', '0', '0');
...
DELETE FROM creature_addon WHERE guid IN (140988,140989,140990);
DELETE FROM creature_movement WHERE id IN (140988,140989,140990);
DELETE FROM game_event_creature WHERE guid IN (140988,140989,140990);
DELETE FROM game_event_creature_data WHERE guid IN (140988,140989,140990);
DELETE FROM creature_battleground WHERE guid IN (140988,140989,140990);
DELETE FROM creature_linking WHERE guid IN (140988,140989,140990)
OR master_guid IN (140988,140989,140990);
DELETE FROM creature WHERE guid IN (140988,140989,140990);
INSERT INTO creature (guid, id, map, spawnMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
DELETE FROM game_event_creature_data WHERE guid BETWEEN 140991 AND 140995;
DELETE FROM creature_battleground WHERE guid BETWEEN 140991 AND 140995;
DELETE FROM creature_linking WHERE guid BETWEEN 140991 AND 140995
OR master_guid BETWEEN 140991 AND 140995;
DELETE FROM creature WHERE guid BETWEEN 140991 AND 140995;
INSERT INTO creature (guid, id, map, spawnMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
-- free guids used
(140991, 23257, 530, 1, 0, 0, 2510.727, 7336.824, 376.875, 5.305801, 300, 300, 0, 0, 45400, 0, 0, 0),
(140992, 23257, 530, 1, 0, 0, 2536.8, 7311.079, 373.7191, 2.251475, 300, 300, 0, 0, 45400, 0, 0, 0),
(140993, 23257, 530, 1, 0, 0, 2544.75, 7335.582, 373.5071, 4.24115, 300, 300, 0, 0, 45400, 0, 0, 0),
(140994, 23257, 530, 1, 0, 0, 2562.316, 7307.93, 366.5525, 5.77704, 300, 300, 0, 0, 45400, 0, 0, 0),
(140995, 23257, 530, 1, 0, 0, 2568.269, 7316.616, 366.208, 5.427974, 300, 300, 0, 0, 45400, 0, 0, 0);
