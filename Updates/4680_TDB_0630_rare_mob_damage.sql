...
UPDATE `creature_template` SET `DamageMultiplier`='1.25', `MeleeBaseAttackTime`='2600' WHERE `entry`='4066'; -- Nal'taszar (1D) (1400 MeleeBaseAttackTime) (94-109 at 30, bestiary) - rare in wotlk
...
UPDATE `creature_template` SET `MinLevel`='15', `MeleeBaseAttackTime` = 2000, `DamageMultiplier` = 1 WHERE `entry` = 7017; -- Lord Sinslayer
...
-- no longer rare elite: 4066,5928
UPDATE `creature_template` SET `DamageMultiplier`='1.25' WHERE `entry`='4066'; -- Nal'taszar (1D) (2600 MeleeBaseAttackTime)
UPDATE `creature_template` SET `DamageMultiplier`='1.0' WHERE `entry`='5928'; -- Sorrow Wing (1D) (2000 MeleeBaseAttackTime)

-- corrections.
UPDATE `creature_template` SET `DamageMultiplier`='3.7' WHERE `entry`='601'; -- Capo the Mean (7.5D) (2000 MeleeBaseAttackTime) - 7.5 is overkill xD 3.7 too but yea get somewhere.
...
UPDATE `creature_template` SET `DamageMultiplier`='2.5', `MeleeBaseAttackTime`='2000' WHERE `entry`='4339'; -- Brimgore (1D) (1275 MeleeBaseAttackTime) (147-195 at 41, bestiary)
UPDATE `creature_template` SET `DamageMultiplier`='1.8' WHERE `entry`='5367'; -- Scillia Daggerquil (7.5D) (2000 MeleeBaseAttackTime)
...
UPDATE `creature_template` SET `DamageMultiplier`='1', `MeleeBaseAttackTime`='2000' WHERE `entry`='5785'; -- Sister Hatelash (1D) (1550 MeleeBaseAttackTime) (14-18 at 11, bestiary)
...
UPDATE `creature_template` SET `DamageMultiplier`='2', `MeleeBaseAttackTime`='2600' WHERE `entry`='5824'; -- Captain Flat Tusk (1.7D) (2600 MeleeBaseAttackTime) (38-50 at 11, bestiary ~39-51)
...
UPDATE `creature_template` SET `MeleeBaseAttackTime`='2000' WHERE `entry`='5912'; -- Deviate Faerie Dragon (1.7D) (1483 MeleeBaseAttackTime)
...
UPDATE `creature_template` SET `DamageMultiplier`='2.3' WHERE `entry`='5931'; -- Foreman Rigger (1.7D) (2400 MeleeBaseAttackTime) (107-124 at 24, bestiary) - variance
...
UPDATE `creature_template` SET `MinLevel`='52' WHERE `entry`='6585'; -- Uhk'loc (1.25D) (2000 MeleeBaseAttackTime)
UPDATE `creature_template` SET `MinLevel`='50' WHERE `entry`='6650'; -- General Fangferror (1D) (2000 MeleeBaseAttackTime)
UPDATE `creature_template` SET `MinLevel`='49' WHERE `entry`='6651'; -- Gatekeeper Rageroar (1D) (2000 MeleeBaseAttackTime)
UPDATE `creature_template` SET `DamageMultiplier`='3', `MeleeBaseAttackTime`='2000' WHERE `entry`='7057'; -- Digmaster Shovelphlange (1D) (1333 MeleeBaseAttackTime) (158-210, at 38, bestiary)
UPDATE `creature_template` SET `DamageMultiplier`='3.6', `MeleeBaseAttackTime`='2000' WHERE `entry`='7104'; -- Dessecus (1D) (1183 MeleeBaseAttackTime) (321-425, at 56, bestiary)
...
UPDATE `creature_template` SET `DamageMultiplier`='4.3' WHERE `entry`='8206'; -- Soul of Tanaris (1D) (2000 MeleeBaseAttackTime) (373-494 at 51, bestiary)
...
UPDATE `creature_template` SET `DamageMultiplier`='3.1', `MeleeBaseAttackTime`='2000' WHERE `entry`='8282'; -- Highlord Mastrogonde (1D) (1183 MeleeBaseAttackTime) (249-330 at 51, bestiary)
...
UPDATE `creature_template` SET `MinLevel`='56' WHERE `entry`='10196'; -- General Colbatann (1D) (1175 MeleeBaseAttackTime)
...
UPDATE `creature_template` SET `DamageMultiplier`='5.20', `MeleeBaseAttackTime`='2000' WHERE `entry`='10393'; -- Skul (1D) (1166 MeleeBaseAttackTime) - variance
...
UPDATE `creature_template` SET `DamageMultiplier`='13' WHERE `entry`='10808'; -- Timmy the Cruel (7.5D) (1400 MeleeBaseAttackTime) (908-1204 at 58, bestiary) - variance
UPDATE `creature_template` SET `DamageMultiplier`='5' WHERE `entry`='10809'; -- Stonespine (3.5D) (2000 MeleeBaseAttackTime) (520-689 at 60, bestiary)
UPDATE `creature_template` SET `MeleeBaseAttackTime` = 2000, `DamageMultiplier` = 1.25 WHERE `entry` = 10817; -- Duggan Wildhammer (118-156 at 55, bestiary)
UPDATE `creature_template` SET `MeleeBaseAttackTime` = 2000, `DamageMultiplier` = 1.25 WHERE `entry` = 10821; -- Hed'mush the Rotting (122-162 at 57, bestiary)
...
UPDATE `creature_template` SET `MinLevel`='60', `MaxLevel`='60', `MeleeBaseAttackTime`='2000', `DamageMultiplier`='1' WHERE `entry`='12116'; -- Priestess of Elune (1D) (1666 MeleeBaseAttackTime)
...
UPDATE `creature_template` SET `DamageMultiplier`='4' WHERE `entry`='14473'; -- Lapress (4.6D) (2000 MeleeBaseAttackTime)
...
UPDATE `creature_template` SET `MinLevel`='71', `MaxLevel`='71' WHERE `entry`='14697'; -- Lumbering Horror (1D) (2000 MeleeBaseAttackTime)
...
UPDATE `creature_template` SET `DamageMultiplier`='3.8' WHERE `entry`='2754'; -- Anathemus (2.4D) (3000 MeleeBaseAttackTime) (426-564 at 45, bestiary)
...
UPDATE `creature_template` SET `DamageMultiplier`='4.5', `MeleeBaseAttackTime`='2000' WHERE `entry`='6583'; -- Gruff (1D) (1175 MeleeBaseAttackTime) (441-584 at 57, bestiary)
