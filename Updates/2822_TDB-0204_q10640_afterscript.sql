...
-- Add text
DELETE FROM `dbscript_string` WHERE `entry`=2000019030;
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`, `comment`, `broadcast_text_id`) VALUES 
(2000019030, 'The information you seek... I cannot give you that freely.  You will have to prove that your enemies are the same as mine.', 0, 0, 0, 25, 'Altruis the Sufferer (Entry: 18417)',19890);
...
(10640,2000,0,0,0,0,0,2000019030,0,0,0,0,0,0,'Altruis the Sufferer - The information you seek... I cannot give you that freely.  You will have to prove that your enemies are the same as mine.',0,0,0,0);
