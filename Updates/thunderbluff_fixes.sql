...
UPDATE `gameobject` SET `position_x` = -1257.8052978515625, `position_y` = 64.37353515625, `position_z` = 127.625152587890625, `orientation` = 1.48352813720703125, `rotation2` = 0.675589561462402343, `rotation3` = 0.737277925014495849 WHERE `guid` = 20621;
...
UPDATE `gameobject` SET `position_x` = -993.115234375, `position_y` = 218.00885009765625, `position_z` = 106.5692367553710937, `orientation` = 4.939284324645996093, `rotation2` = -0.6225137710571289, `rotation3` = 0.78260880708694458 WHERE `guid` = 63171;
UPDATE `gameobject` SET `position_x` = -944.06427001953125, `position_y` = 274.859375, `position_z` = 111.7099990844726562 WHERE `guid` = 520952;


-- missing objects (free guids used and 1 deleted guid reused)
DELETE FROM `gameobject` WHERE `guid` IN (20556, 11115, 11116, 11117);
...
(20556, 152583, 1, 1, 1, -1257.8424072265625, 24.41799354553222656, 128.217498779296875, 2.888511419296264648, 0, 0, 0.99200439453125, 0.126203224062919616, 120, 120),
(11115, 185004, 1, 1, 1, -1049.5347900390625, -290.34722900390625, 159.0303497314453125, 0.209439441561698913, 0, 0, 0.104528427124023437, 0.994521915912628173, 120, 120),
(11116, 185004, 1, 1, 1, -1050.2257080078125, -290.552093505859375, 159.0303497314453125, 2.495818138122558593, 0, 0, 0.948323249816894531, 0.317305892705917358, 120, 120),
(11117, 182257, 1, 1, 1, -1049.82470703125, -286.196197509765625, 159.0303497314453125, 2.548179388046264648, 0, 0, 0.956304550170898437, 0.292372345924377441, 120, 120);
