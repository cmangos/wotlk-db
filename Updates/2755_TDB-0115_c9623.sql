...
UPDATE `creature_template_addon` SET `bytes1` = 0 WHERE `entry` = 9623;
...
UPDATE `creature_template_addon` SET `bytes1` = 0 WHERE `entry` = 9999;
...
UPDATE `creature_template_addon` SET `bytes1` = 0 WHERE `entry` = 5644;
