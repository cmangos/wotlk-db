...
UPDATE `creature` SET `spawndist` = 0, `MovementType` = 0 WHERE `guid` IN (14081,14096,14108,14116,14117,14119,14166,14174,14175,14187,14256,14548);
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (113, 0, 0, 1, 16, 0, 0, NULL);
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (1053, 0, 0, 1, 16, 0, 0, '7164'); -- bytes1 1179648
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (1179, 0, 0, 1, 16, 0, 0, '7165'); -- bytes1 1114112
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (2242, 0, 33554432, 1, 16, 0, 0, '22766'); -- bytes1 33554432
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (2246, 0, 33554432, 1, 16, 0, 0, '22766 7276'); -- bytes1 33554432
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (2586, 0, 33554432, 1, 16, 0, 0, '22766'); -- bytes1 33554432
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (2926, 0, 33554432, 1, 16, 0, 0, '6408'); -- bytes1 33554432
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (3763, 0, 33554432, 1, 16, 0, 0, '22766'); -- bytes1 131072
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (7110, 0, 33554432, 1, 16, 0, 0, '6408'); -- bytes1 33554432
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (7432, 0, 33554432, 1, 16, 0, 0, '6408'); -- bytes1 131072
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES (12856, 0, 33554432, 1, 16, 0, 0, '20540'); -- bytes1 131072
...
DELETE FROM `creature` WHERE `guid` IN (73192,82379);
DELETE FROM `creature_addon` WHERE `guid` IN (73192,82379);
DELETE FROM `creature_movement` WHERE `id` IN (73192,82379);
DELETE FROM `game_event_creature` WHERE `guid` IN (73192,82379);
DELETE FROM `game_event_creature_data` WHERE `guid` IN (73192,82379);
DELETE FROM `creature_battleground` WHERE `guid` IN (73192,82379);
DELETE FROM `creature_linking` WHERE `guid` IN (68988,73192,82379)
 OR `master_guid` IN (73192,82379);
DELETE FROM `pool_creature` WHERE `guid` IN (73192,82379);
