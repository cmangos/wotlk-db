...
UPDATE `creature_template` SET `MinLevel` = 54, `MaxLevel` = 55, `DifficultyEntry1` = 22748 WHERE `entry` = 11602; -- Irondeep Skullthumper (64-65) - do all again even if already right to align levels, av is just messy
UPDATE `creature_template` SET `MinLevel` = 64, `MaxLevel` = 65 WHERE `entry` = 22748;
UPDATE `creature_template` SET `MinLevel` = 58, `MaxLevel` = 59, `DifficultyEntry1` = 22783 WHERE `entry` = 11840; -- Wildpaw Alpha (68-69)
UPDATE `creature_template` SET `MinLevel` = 68, `MaxLevel` = 69 WHERE `entry` = 22783;
UPDATE `creature_template` SET `MinLevel` = 60, `MaxLevel` = 60, `DifficultyEntry1` = 22540 WHERE `entry` = 12121; -- Draka (70-70)
UPDATE `creature_template` SET `MinLevel` = 70, `MaxLevel` = 70 WHERE `entry` = 22540;
UPDATE `creature_template` SET `MinLevel` = 60, `MaxLevel` = 60, `DifficultyEntry1` = 22546 WHERE `entry` = 12122; -- Duros (70-70)
UPDATE `creature_template` SET `MinLevel` = 70, `MaxLevel` = 70 WHERE `entry` = 22546;
UPDATE `creature_template` SET `MinLevel` = 59, `MaxLevel` = 59, `DifficultyEntry1` = 22707 WHERE `entry` = 13137; -- Lieutenant Rugba (69-69)
UPDATE `creature_template` SET `MinLevel` = 69, `MaxLevel` = 69 WHERE `entry` = 22707;
UPDATE `creature_template` SET `MinLevel` = 60, `MaxLevel` = 60, `DifficultyEntry1` = 22598 WHERE `entry` = 13181; -- Wing Commander Mulverick (70-70)
UPDATE `creature_template` SET `MinLevel` = 70, `MaxLevel` = 70 WHERE `entry` = 22598;
UPDATE `creature_template` SET `MinLevel` = 58, `MaxLevel` = 58, `DifficultyEntry1` = 22681 WHERE `entry` = 13218; -- Wing Commander Mulverick (58-58) - wrong lvl classicmangos
UPDATE `creature_template` SET `MinLevel` = 68, `MaxLevel` = 68 WHERE `entry` = 22681;
UPDATE `creature_template` SET `MinLevel` = 60, `MaxLevel` = 60, `DifficultyEntry1` = 22567 WHERE `entry` = 13257; -- Wing Commander Mulverick (58-58)
UPDATE `creature_template` SET `MinLevel` = 70, `MaxLevel` = 70 WHERE `entry` = 22567;
UPDATE `creature_template` SET `MinLevel` = 59, `MaxLevel` = 59, `DifficultyEntry1` = 22709 WHERE `entry` = 13297; -- Lieutenant Stouthandle (69-69)
UPDATE `creature_template` SET `MinLevel` = 69, `MaxLevel` = 69 WHERE `entry` = 22709;
UPDATE `creature_template` SET `MinLevel` = 59, `MaxLevel` = 59, `DifficultyEntry1` = 22705 WHERE `entry` = 13300; -- Lieutenant Mancuso (69-69)
UPDATE `creature_template` SET `MinLevel` = 69, `MaxLevel` = 69 WHERE `entry` = 22705;
UPDATE `creature_template` SET `MinLevel` = 61, `MaxLevel` = 61, `DifficultyEntry1` = 22618 WHERE `entry` = 13318; -- Commander Mortimer (71-71)
UPDATE `creature_template` SET `MinLevel` = 71, `MaxLevel` = 71 WHERE `entry` = 22618;
UPDATE `creature_template` SET `MinLevel` = 56, `MaxLevel` = 56, `DifficultyEntry1` = 22662 WHERE `entry` = 13325; -- Seasoned Mountaineer (66-66)
UPDATE `creature_template` SET `MinLevel` = 66, `MaxLevel` = 66 WHERE `entry` = 22662;
UPDATE `creature_template` SET `MinLevel` = 57, `MaxLevel` = 57, `DifficultyEntry1` = 22667 WHERE `entry` = 13335; -- Veteran Mountaineer (67-67)
UPDATE `creature_template` SET `MinLevel` = 67, `MaxLevel` = 67 WHERE `entry` = 22667;
UPDATE `creature_template` SET `MinLevel` = 58, `MaxLevel` = 58, `DifficultyEntry1` = 22672 WHERE `entry` = 13427; -- Champion Sentinel (68-68)
UPDATE `creature_template` SET `MinLevel` = 68, `MaxLevel` = 68 WHERE `entry` = 22672;
UPDATE `creature_template` SET `MinLevel` = 61, `MaxLevel` = 61, `DifficultyEntry1` = 22639 WHERE `entry` = 13449; -- Warmaster Garrick (71-71)
UPDATE `creature_template` SET `MinLevel` = 71, `MaxLevel` = 71 WHERE `entry` = 22639;
UPDATE `creature_template` SET `MinLevel` = 61, `MaxLevel` = 61, `DifficultyEntry1` = 22607 WHERE `entry` = 13527; -- Champion Commando (71-71)
UPDATE `creature_template` SET `MinLevel` = 71, `MaxLevel` = 71 WHERE `entry` = 22607;
UPDATE `creature_template` SET `MinLevel` = 60, `MaxLevel` = 60, `DifficultyEntry1` = 22592 WHERE `entry` = 13530; -- Veteran Reaver (70-70)
UPDATE `creature_template` SET `MinLevel` = 70, `MaxLevel` = 70 WHERE `entry` = 22592;
UPDATE `creature_template` SET `MinLevel` = 60, `MaxLevel` = 60, `DifficultyEntry1` = 22531 WHERE `entry` = 13551; -- Champion Coldmine Invader (70-70)
UPDATE `creature_template` SET `MinLevel` = 70, `MaxLevel` = 70 WHERE `entry` = 22531;
UPDATE `creature_template` SET `MinLevel` = 50, `MaxLevel` = 51, `DifficultyEntry1` = 22765 WHERE `entry` = 13618; -- Stabled Frostwolf (60-61)
UPDATE `creature_template` SET `MinLevel` = 60, `MaxLevel` = 61 WHERE `entry` = 22765;
UPDATE `creature_template` SET `MinLevel` = 61, `MaxLevel` = 61, `DifficultyEntry1` = 22604 WHERE `entry` = 13959; -- Alterac Yeti (71-71)
UPDATE `creature_template` SET `MinLevel` = 71, `MaxLevel` = 71 WHERE `entry` = 22604;
UPDATE `creature_template` SET `MinLevel` = 57, `MaxLevel` = 58, `DifficultyEntry1` = 22794 WHERE `entry` = 10983; -- Winterax Troll (56-58)
UPDATE `creature_template` SET `MinLevel` = 67, `MaxLevel` = 68 WHERE `entry` = 22794;
UPDATE `creature_template` SET `MinLevel` = 59, `MaxLevel` = 59, `DifficultyEntry1` = 22699 WHERE `entry` = 14188; -- Dirk Swindle (59-59)
...
DELETE FROM `reference_loot_template` WHERE `entry` IN (24026,24017,24019,24028,24030,24032,24034,24038,24040,24042,24044,24046,24049,24051,24053,24055,24057,24061,24063,24065,24067,24069,24021);
...
-- NAXX NPCS
DELETE FROM `creature_loot_template` WHERE (mincountorref between -60284 AND -60200)
...
DELETE FROM `reference_loot_template` WHERE (`mincountorref` IN (-24017,-24019,-24026,-24028,-24030,-24032,-24034,-24038,-24040,-24042,-24044,-24046,-24049,-24051,-24053,-24055,-24057,-24061,-24063,-24065,-24067,-24069));

-- overlapping
DELETE FROM `reference_loot_template` WHERE `entry` = 30001 AND `item` IN (44758,44759);
DELETE FROM `creature_loot_template` WHERE `mincountOrRef` =-30001 AND `entry` IN (15975,15979);
REPLACE INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`) VALUES
(15975, 44758, 71, 0, 2, 4, 0),
(15975, 44759, 16, 0, 2, 3, 0),
(15979, 44758, 71, 0, 2, 4, 0),
(15979, 44759, 16, 0, 2, 3, 0);

REPLACE INTO `reference_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`) VALUES
(30001, 1318, 0, 1, 1, 1, 0),
(30001, 1482, 0, 1, 1, 1, 0),
(30001, 1483, 0, 1, 1, 1, 0),
(30001, 1484, 0, 1, 1, 1, 0),
(30001, 1489, 0, 1, 1, 1, 0),
(30001, 1935, 0, 1, 1, 1, 0),
(30001, 1974, 0, 1, 1, 1, 0),
(30001, 2205, 0, 1, 1, 1, 0),
(30001, 2292, 0, 1, 1, 1, 0),
(30001, 2807, 0, 1, 1, 1, 0),
(30001, 3194, 0, 1, 1, 1, 0),
(30002, 1454, 0, 1, 1, 1, 0),
(30002, 1481, 0, 1, 1, 1, 0),
(30002, 1486, 0, 1, 1, 1, 0),
(30002, 1491, 0, 1, 1, 1, 0),
(30002, 2271, 0, 1, 1, 1, 0),
(30002, 2567, 0, 1, 1, 1, 0),
(30002, 3413, 0, 1, 1, 1, 0),
(30002, 3414, 0, 1, 1, 1, 0),
(30002, 3415, 0, 1, 1, 1, 0),
(30002, 3416, 0, 1, 1, 1, 0),
(30002, 3417, 0, 1, 1, 1, 0),
(30003, 776, 0, 1, 1, 1, 0),
(30003, 1488, 0, 1, 1, 1, 0),
(30003, 1727, 0, 1, 1, 1, 0),
(30003, 1975, 0, 1, 1, 1, 0),
(30003, 1976, 0, 1, 1, 1, 0),
(30003, 1978, 0, 1, 1, 1, 0),
(30003, 2039, 0, 1, 1, 1, 0),
(30003, 2264, 0, 1, 1, 1, 0),
(30003, 2549, 0, 1, 1, 1, 0),
(30003, 4438, 0, 1, 1, 1, 0),
(30004, 9485, 0, 1, 1, 1, 0),
(30004, 9486, 0, 1, 1, 1, 0),
(30004, 9487, 0, 1, 1, 1, 0),
(30004, 9488, 0, 1, 1, 1, 0),
(30004, 9489, 0, 1, 1, 1, 0),
(30004, 9490, 0, 1, 1, 1, 0),
(30004, 9491, 0, 1, 1, 1, 0),
(30004, 9508, 0, 1, 1, 1, 0),
(30004, 9509, 0, 1, 1, 1, 0),
(30004, 9510, 0, 1, 1, 1, 0),
(30005, 1992, 0, 1, 1, 1, 0),
(30005, 2262, 0, 1, 1, 1, 0),
(30005, 5756, 0, 1, 1, 1, 0),
(30005, 5819, 0, 1, 1, 1, 0),
(30005, 7727, 0, 1, 1, 1, 0),
(30005, 7728, 0, 1, 1, 1, 0),
(30005, 7729, 0, 1, 1, 1, 0),
(30005, 7730, 0, 1, 1, 1, 0),
(30005, 7736, 0, 1, 1, 1, 0),
(30005, 7752, 0, 1, 1, 1, 0),
(30005, 7753, 0, 1, 1, 1, 0),
(30005, 7754, 0, 1, 1, 1, 0),
(30005, 7755, 0, 1, 1, 1, 0),
(30005, 7757, 0, 1, 1, 1, 0),
(30005, 7758, 0, 1, 1, 1, 0),
(30005, 7759, 0, 1, 1, 1, 0),
(30005, 7760, 0, 1, 1, 1, 0),
(30005, 7761, 0, 1, 1, 1, 0),
(30005, 7786, 0, 1, 1, 1, 0),
(30005, 7787, 0, 1, 1, 1, 0),
(30005, 8225, 0, 1, 1, 1, 0),
(30005, 8226, 0, 1, 1, 1, 0),
(30005, 10332, 0, 1, 1, 1, 0),
(30006, 10567, 0, 1, 1, 1, 0),
(30006, 10570, 0, 1, 1, 1, 0),
(30006, 10571, 0, 1, 1, 1, 0),
(30006, 10572, 0, 1, 1, 1, 0),
(30006, 10573, 0, 1, 1, 1, 0),
(30006, 10574, 0, 1, 1, 1, 0),
(30006, 10578, 0, 1, 1, 1, 0),
(30006, 10581, 0, 1, 1, 1, 0),
(30006, 10582, 0, 1, 1, 1, 0),
(30006, 10583, 0, 1, 1, 1, 0),
(30006, 10584, 0, 1, 1, 1, 0),
(30007, 9381, 0, 1, 1, 1, 0),
(30007, 9383, 0, 1, 1, 1, 0),
(30007, 9384, 0, 1, 1, 1, 0),
(30007, 9386, 0, 1, 1, 1, 0),
(30007, 9391, 0, 1, 1, 1, 0),
(30007, 9392, 0, 1, 1, 1, 0),
(30007, 9393, 0, 1, 1, 1, 0),
(30007, 9396, 0, 1, 1, 1, 0),
(30007, 9397, 0, 1, 1, 1, 0),
(30007, 9406, 0, 1, 1, 1, 0),
(30007, 9420, 0, 1, 1, 1, 0),
(30007, 9422, 0, 1, 1, 1, 0),
(30007, 9423, 0, 1, 1, 1, 0),
(30007, 9424, 0, 1, 1, 1, 0),
(30007, 9425, 0, 1, 1, 1, 0),
(30007, 9426, 0, 1, 1, 1, 0),
(30007, 9427, 0, 1, 1, 1, 0),
(30007, 9428, 0, 1, 1, 1, 0),
(30007, 9429, 0, 1, 1, 1, 0),
(30007, 9430, 0, 1, 1, 1, 0),
(30007, 9431, 0, 1, 1, 1, 0),
(30007, 9432, 0, 1, 1, 1, 0),
(30007, 9465, 0, 1, 1, 1, 0),
(30008, 862, 0, 1, 1, 1, 0),
(30008, 2040, 0, 1, 1, 1, 0),
(30008, 5616, 0, 1, 1, 1, 0),
(30008, 6440, 0, 1, 1, 1, 0),
(30008, 9480, 0, 1, 1, 1, 0),
(30008, 9481, 0, 1, 1, 1, 0),
(30008, 9482, 0, 1, 1, 1, 0),
(30008, 9483, 0, 1, 1, 1, 0),
(30008, 9484, 0, 1, 1, 1, 0),
(30008, 9511, 0, 1, 1, 1, 0),
(30008, 9512, 0, 1, 1, 1, 0),
(30009, 10623, 0, 1, 1, 1, 0),
(30009, 10624, 0, 1, 1, 1, 0),
(30009, 10625, 0, 1, 1, 1, 0),
(30009, 10626, 0, 1, 1, 1, 0),
(30009, 10627, 0, 1, 1, 1, 0),
(30009, 10628, 0, 1, 1, 1, 0),
(30009, 10629, 0, 1, 1, 1, 0),
(30009, 10630, 0, 1, 1, 1, 0),
(30009, 10631, 0, 1, 1, 1, 0),
(30009, 10632, 0, 1, 1, 1, 0),
(30009, 10633, 0, 1, 1, 1, 0),
(30009, 10634, 0, 1, 1, 1, 0),
(30010, 12527, 0, 1, 1, 1, 0),
(30010, 12528, 0, 1, 1, 1, 0),
(30010, 12531, 0, 1, 1, 1, 0),
(30010, 12532, 0, 1, 1, 1, 0),
(30010, 12535, 0, 1, 1, 1, 0),
(30010, 12542, 0, 1, 1, 1, 0),
(30010, 12546, 0, 1, 1, 1, 0),
(30010, 12547, 0, 1, 1, 1, 0),
(30010, 12549, 0, 1, 1, 1, 0),
(30010, 12550, 0, 1, 1, 1, 0),
(30010, 12551, 0, 1, 1, 1, 0),
(30010, 12552, 0, 1, 1, 1, 0),
(30010, 12555, 0, 1, 1, 1, 0);
...
DELETE FROM `creature_loot_template` WHERE `mincountOrRef` IN (-24150,-24151,-24153,-24157,-24157,-24154,-24158,-24152,-24160,-24162,-24161,-24159,-24168,-24169,-24021,-24026,-24170);
DELETE FROM `reference_loot_template` WHERE `entry` IN (24150,24151,24153,24157,24157,24154,24158,24152,24160,24162,24161,24159,24168,24169,24021,24026,24170);
