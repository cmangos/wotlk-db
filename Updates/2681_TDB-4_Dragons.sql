...
-- need to be deleted - Ahn’Qiraj Temple 531map was used by mistake
...
-- correct TBC Range 530+ used
DELETE FROM game_event_gameobject WHERE guid BETWEEN 5309450 AND 5319093;
DELETE FROM gameobject_battleground WHERE guid BETWEEN 5309450 AND 5319093;
DELETE FROM gameobject WHERE guid BETWEEN 5309450 AND 5319093; 

SET @OBSIDIA_NEST := 5309450;
...
(8685, 0, 0, 'Place 35 Apexis Shards near the dragon egg to crack it open.', 1, 0, -1, 0, 868501, 0, 0, NULL, 883);
...
INSERT INTO `gossip_menu_option` (`menu_id`, `id`, `option_icon`, `option_text`, `option_id`, `npc_option_npcflag`, `action_menu_id`, `action_poi_id`, `action_script_id`, `box_coded`, `box_money`, `box_text`, `condition_id`) VALUES
(8689, 0, 0, 'Place 35 Apexis Shards near the dragon egg to crack it open.', 1, 0, -1, 0, 868901, 0, 0, NULL, 883);
...
INSERT INTO `gossip_menu_option` (`menu_id`, `id`, `option_icon`, `option_text`, `option_id`, `npc_option_npcflag`, `action_menu_id`, `action_poi_id`, `action_script_id`, `box_coded`, `box_money`, `box_text`, `condition_id`) VALUES
(8690, 0, 0, 'Place 35 Apexis Shards near the dragon egg to crack it open.', 1, 0, -1, 0, 869001, 0, 0, NULL, 883);
...
INSERT INTO `gossip_menu_option` (`menu_id`, `id`, `option_icon`, `option_text`, `option_id`, `npc_option_npcflag`, `action_menu_id`, `action_poi_id`, `action_script_id`, `box_coded`, `box_money`, `box_text`, `condition_id`) VALUES 
(8691, 0, 0, 'Place 35 Apexis Shards near the dragon egg to crack it open.', 1, 0, -1, 0, 869101, 0, 0, NULL, 883);
