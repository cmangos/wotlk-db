...
DELETE FROM conditions WHERE condition_entry IN (1432);
INSERT INTO conditions (condition_entry, type, value1, value2, comments) VALUES
(1432, 12, 10, 0, 'Event ID 10 Active');
DELETE FROM gossip_menu_option WHERE menu_id=5848;
INSERT INTO gossip_menu_option (menu_id, id, option_icon, option_text, option_broadcast_text, option_id, npc_option_npcflag, action_menu_id, action_poi_id, action_script_id, box_coded, box_money, box_text, box_broadcast_text, condition_id) VALUES
(5848, 1, 0, 'Well what do you know, this is Children''s Week! What can I do to help?', 9675, 1, 1, 60001, 0, 0, 0, 0, '', 0, 1432);
UPDATE gossip_menu_option SET option_broadcast_text=9675, action_menu_id=60000, condition_id=1432 WHERE menu_id=5849;
