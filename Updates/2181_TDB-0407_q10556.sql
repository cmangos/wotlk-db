...
UPDATE creature_template SET Faction=1629, SpeedWalk=3.5/2.5, SpeedRun=10/7, UnitFlags=33555200 WHERE entry=21468; -- Kaliri Totem
...
DELETE FROM gameobject WHERE id=184826;
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(160194, 184826, 530, 1, 1637.021, 6998.459, 158.3239, 1.308997, 0, 0, 0, 0, 180, 180, 0, 1),
(160195, 184826, 530, 1, 1612.651, 6934.456, 160.0191, 5.707227, 0, 0, 0, 0, 180, 180, 0, 1);
