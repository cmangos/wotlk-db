...
(4, 3000, 0, 902, 0, 0, 1370, 50, 0, 0, 0, 0, 0, 0, 0, 0, 0, 'Brandon 1370 - Random Text'),
(4, 14000, 0, 903, 0, 0, 1371, 50, 0, 0, 0, 0, 0, 0, 0, 0, 0, 'Roman 1371 - Random Text');
...
UPDATE `creature` SET spawndist = 0, `MovementType`=0 WHERE `id` IN (1368,1370,1371);
