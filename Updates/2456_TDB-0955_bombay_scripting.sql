...
DELETE FROM `conditions` WHERE `condition_entry`=3000;
INSERT INTO `conditions` (`condition_entry`, `type`, `value1`, `value2`, `comments`) VALUES
(3000, 8, 826, 0, 'Quest ID 826 Rewarded');
...
(3062, 0, 0, 'Low spirits', 1, 1, -1, 0, 3062, 0, 0, '', 3000),
(3062, 1, 0, 'Bad hang nail', 1, 1, -1, 0, 3062, 0, 0, '', 3000),
(3062, 2, 0, 'Feeling underpowered', 1, 1, -1, 0, 3062, 0, 0, '', 3000),
(3062, 3, 0, 'Jungle Fever', 1, 1, -1, 0, 3062, 0, 0, '', 3000),
(3062, 4, 0, 'Uni-brow', 1, 1, -1, 0, 3062, 0, 0, '', 3000),
(3062, 5, 0, 'Whiplash', 1, 1, -1, 0, 3062, 0, 0, '', 3000),
(3062, 6, 0, 'I don\'t want to go back to work', 1, 1, -1, 0, 3062, 0, 0, '', 3000);
