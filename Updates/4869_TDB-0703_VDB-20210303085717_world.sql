...
-- wotlk does this clientside via spell_template
...
UPDATE `creature_template` SET `EquipmentTemplateId` = 5848 WHERE `entry` = 5848;
DELETE FROM `creature_equip_template` WHERE `entry` = 5848 AND `equipentry1` = 3361;
INSERT INTO `creature_equip_template` (`entry`, `equipentry1`, `equipentry2`, `equipentry3`) VALUES (5848, 3361, 0, 0);
