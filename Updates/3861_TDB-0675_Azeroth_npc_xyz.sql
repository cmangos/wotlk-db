...
UPDATE `creature` SET `position_x` = 349.7298, `position_y` = -4675.845, `position_z` = 16.54111, `orientation` = 3.054326 WHERE `guid` = 3416 AND `id` = 11943; -- Magga - Patch 2.4.3 (2008-07-15):  Moved from Valley of Trials to Razor Hill.
UPDATE `creature` SET `position_x` = -2328.494, `position_y` = -382.2685, `position_z` = -7.999938, `orientation` = 1.797689 WHERE `guid` = 26568 AND `id` = 11944; -- Vorn Skyseer - Patch 2.4.3 (2008-07-15): Moved from Camp Narache to Bloodhoof Village.
UPDATE `creature` SET `position_x` = 2286.15, `position_y` = 247.8046, `position_z` = 41.19807, `orientation` = 3.193953 WHERE `guid` = 31923 AND `id` = 11945; -- Claire Willower - Patch 2.4.3 (2008-07-15): Moved from Deathknell to Brill.
