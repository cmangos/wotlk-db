...
DELETE FROM creature_addon WHERE guid = 75870;
DELETE FROM creature_movement WHERE id = 75870;
DELETE FROM game_event_creature WHERE guid = 75870;
DELETE FROM game_event_creature_data WHERE guid = 75870;
DELETE FROM creature_battleground WHERE guid = 75870;
DELETE FROM creature_linking WHERE guid = 75870 
OR master_guid = 75870;
INSERT INTO creature (guid, id, map, spawnmask, phasemask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) values
(75870,1380,0,1,1,0,0,-5760.73,-3437.71,305.54,2.41,300,300,0,0,247,0,0,0);
-- Stats & Equip updated
