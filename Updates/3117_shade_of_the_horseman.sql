...
DELETE FROM game_event_creature WHERE guid IN (80341,80342,80343,79648) AND `event`=-12;
INSERT INTO game_event_creature (guid, `event`) SELECT guid, -12 FROM creature WHERE guid IN (80341,80342,80343,79648);
