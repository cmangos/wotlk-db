...
-- Azaloth
UPDATE creature_template SET UnitFlags = 33024 WHERE entry = 21506;
UPDATE creature_template_addon SET auras = NULL WHERE entry = 21506;
-- Demon Hunter Supllicant, Sunfury Warlock
UPDATE creature_template SET FactionAlliance = 1826, FactionHorde = 1826 WHERE entry IN (21179,21503);
