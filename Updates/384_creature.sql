...
(60792,7015,0,1,1,1,7410.98,-9.27966,0.831176,1.88702,9900,15,356,0,1);

-- Only one can be spawned at at the same time
DELETE FROM pool_template WHERE entry = 25518;
INSERT INTO pool_template (entry, max_limit, description) VALUES 
(25518,1,'Flagglemurk the Cruel');
DELETE FROM pool_creature_template WHERE pool_entry = 25518;
INSERT INTO pool_creature_template (id, pool_entry, chance, description) VALUES
(7015, 25518, 0, 'RARE Flagglemurk the Cruel - 7015');
