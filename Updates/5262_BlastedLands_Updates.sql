...
(140996,6011,0,1,1,-11866.32,-3349.4456,18.78506,0,300,300,0,0),
(140997,6010,0,1,1,-11866.32,-3349.4456,18.78506,0,300,300,0,0);
...
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) VALUES
(140998,6011,0,1,1,-11894.97,-3063.0215,22.201347,0,300,300,0,0),
(140999,6010,0,1,1,-11894.97,-3063.0215,22.201347,0,300,300,0,0);
...
-- Dreadscorn 8304
-- custom path corrected
UPDATE creature SET position_x = -11540.997, position_y = -2896.7283, position_z = 10.740564, spawndist = 0, MovementType = 4 WHERE id = 8304;
UPDATE creature_template SET EquipmentTemplateId = 1396, MovementType = 4 WHERE Entry = 8304; -- (VirtualItems) [0] ItemID: 10568
...
UPDATE creature SET spawndist = 0, MovementType = 0 WHERE guid IN (2995,2738,2887);

-- Dreadlord 8716
-- missing added
DELETE FROM creature_addon WHERE guid IN (3641); -- free for all 3 dbs
DELETE FROM creature_movement WHERE id IN (3641);
DELETE FROM game_event_creature WHERE guid IN (3641);
DELETE FROM game_event_creature_data WHERE guid IN (3641);
DELETE FROM creature_battleground WHERE guid IN (3641);
DELETE FROM creature_linking WHERE guid IN (3641);
DELETE FROM creature where guid IN (3641);
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) VALUES
(3641,8716,0,1,1,-12193.036,-2755.4004,22.25879,2.28638,300,300,0,0);
