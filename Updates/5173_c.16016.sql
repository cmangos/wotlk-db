...
UPDATE creature_template SET EquipmentTemplateId = 250 WHERE Entry = 16016;
...
DELETE FROM creature_addon WHERE guid IN (SELECT guid FROM creature WHERE id IN (16016));
