...
(7482,0,0,'Listen to me, human. I care nothing for your plight, but you have something I require. Tell me where to find the bloodforged ingots.',1,1,7483,0,0,0,'',1481,1782201);

DELETE FROM `conditions` WHERE `condition_entry`=1481;
INSERT INTO `conditions` (`condition_entry`,`type`,`value1`,`value2`,`comments`) VALUES
(1481,9,9692,0,'gossip option on Landen Stilwell requires The Path of the Adept taken');
