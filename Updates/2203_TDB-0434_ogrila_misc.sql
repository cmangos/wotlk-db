...
-- ---------------------------
-- 140988 Moves back and forth on the launch platform
UPDATE creature SET MovementType=2, spawndist=0 WHERE guid=140988;
DELETE FROM `creature_movement` WHERE `id`=140988;
INSERT INTO `creature_movement` (`id`,`point`,`position_x`,`position_y`,`position_z`,`waittime`,`script_id`,`orientation`) VALUES
(140988,1,2522.945,7322.241,373.4666,15000,2298203,6.161012),
(140988,2,2539.765,7322.653,373.4608,22000,2298204,3.001966);

UPDATE creature SET MovementType=2, spawndist=0, equipment_id=67 WHERE guid=140990;
DELETE FROM `creature_movement` WHERE `id`=140990;
INSERT INTO `creature_movement` (`id`,`point`,`position_x`,`position_y`,`position_z`,`waittime`,`script_id`,`orientation`) VALUES
(140990,1,2514.656,7355.287,380.8192,10000,1092,2.932153);
...
INSERT INTO `dbscripts_on_creature_movement` (`id`,`delay`,`command`,`datalong`,`datalong2`,`datalong3`,`dataint`,`dataint2`,`dataint3`,`dataint4`,`buddy_entry`,`search_radius`,`data_flags`,`comments`,`x`,`y`,`z`,`o`) VALUES
(1092,0,1,92,0,0,0,0,0,0,0,0,0x04,'GENERIC EMOTE - ONESHOT_EAT_NOSHEATHE',0,0,0,0);
