...
-- Old Condition 522 - (Quest ID 5503 Rewarded AND Player Has Less Than 1 of Item ID 12846 in Inventory)
...
-- unlink all involved quests (without checking whether the quest assignment is correct or not) [the fast way]
DELETE FROM creature_questrelation WHERE quest IN (5401, 5402, 5403, 5404, 5405, 5406, 5407, 5408, 5503);
DELETE FROM creature_involvedrelation WHERE quest IN (5401, 5402, 5403, 5404, 5405, 5406, 5407, 5408, 5503);

-- link all involved quests with their respective giver/taker
-- Chillwind Camp
...
UPDATE quest_template SET RequiredRaces = 0 WHERE entry IN (5503, 5508); -- both factions!
