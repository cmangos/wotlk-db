-- Improved gossip for two Thorium Brotherhood NPCs: they will change depending on the reputation players have with that faction
...
(1183, 5, 59, 5);
UPDATE gossip_menu SET condition_id = 1183 WHERE entry = 5962 AND text_id = 7121;
