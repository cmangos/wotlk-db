...
-- One was missing. Move all of them to a new range and use classic-db data.
DELETE FROM `creature` WHERE `guid`=151044;
INSERT INTO `creature` (`guid`, `id`, `map`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES (151044, 12099, 409, 0, 0, 670.292, -495.011, -212.488, 0, 7200, 0, 0, 61040, 0, 0, 0);
DELETE FROM `creature` WHERE `guid`=151045;
INSERT INTO `creature` (`guid`, `id`, `map`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES (151045, 12099, 409, 0, 0, 675.193, -489.132, -212.679, 0, 7200, 0, 0, 61040, 0, 0, 0);
DELETE FROM `creature` WHERE `guid`=151046;
INSERT INTO `creature` (`guid`, `id`, `map`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES (151046, 12099, 409, 0, 0, 676.861, -507.534, -214.248, 0, 7200, 0, 0, 61040, 0, 0, 0);
DELETE FROM `creature` WHERE `guid`=151047;
INSERT INTO `creature` (`guid`, `id`, `map`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES (151047, 12099, 409, 0, 0, 683.046, -488.763, -213.224, 0, 7200, 0, 0, 61040, 0, 0, 0);
DELETE FROM `creature` WHERE `guid`=151048;
INSERT INTO `creature` (`guid`, `id`, `map`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES (151048, 12099, 409, 0, 0, 688.694, -493.342, -213.977, 0, 7200, 0, 0, 61040, 0, 0, 0);
DELETE FROM `creature` WHERE `guid`=151049;
INSERT INTO `creature` (`guid`, `id`, `map`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES (151049, 12099, 409, 0, 0, 689.302, -501.019, -214.331, 0, 7200, 0, 0, 61040, 0, 0, 0);
DELETE FROM `creature` WHERE `guid`=151050;
INSERT INTO `creature` (`guid`, `id`, `map`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES (151050, 12099, 409, 0, 0, 684.192, -506.928, -214.424, 0, 7200, 0, 0, 61040, 0, 0, 0);
DELETE FROM `creature` WHERE `guid`=151051;
INSERT INTO `creature` (`guid`, `id`, `map`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES (151051, 12099, 409, 0, 0, 671.092, -502.33, -213.129, 0, 7200, 0, 0, 61040, 0, 0, 0);
