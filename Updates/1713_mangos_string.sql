-- Add new updated threat string
UPDATE mangos_string SET content_default='Player |cffff0000%s|r [GUID: %u] has |cffff0000%f|r threat and taunt state %u' WHERE entry IN (1702);
