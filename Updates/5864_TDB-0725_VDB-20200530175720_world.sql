...
(127601, 120000, 0, 0, 0, 0, 0, 0, 0, 0, 114, 0, 0, 0, 0, 0, 0, 0, 0, 'Mountaineer Brokk 1276 - Say on Patrol Start');
...
UPDATE `creature_movement` SET `positionx` = -4913.53, `positiony` = -2728.87, `positionz` = 328.943, `waittime` = 30000, `orientation` = 100 WHERE `id` = 8267 AND `point` = 5;
