...
SET @CREATURE_0 := 11161; -- WotlkDB has to find free guids
SET @CREATURE_1 := 11001;
SET @CREATURE_2 := 11002;
SET @CREATURE_3 := 11003;
SET @CREATURE_4 := 11004;
SET @CREATURE_5 := 11215; -- WotlkDB has to find free guids
SET @CREATURE_6 := 11390; -- WotlkDB has to find free guids
