...
UPDATE creature_template SET EquipmentTemplateId = 512 WHERE entry = 2766;
UPDATE creature SET spawndist = 2, MovementType = 1 WHERE id = 2766;

-- First Mate Nilzlix 2767
UPDATE creature_template SET EquipmentTemplateId = 2502 WHERE entry = 2767;
UPDATE creature SET spawndist = 2, MovementType = 1 WHERE id = 2767;

-- Professor Phizzlethorpe 2768
UPDATE creature_template SET EquipmentTemplateId = 1296 WHERE entry = 2768;
