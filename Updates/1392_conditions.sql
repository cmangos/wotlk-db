-- Fix the condition for the quest-giving item Murloc Escape Plans from Sludge Covered Object
-- The item should drop when:
...
(32724, 32726, 2, 0, 1, 1, 1413);

DELETE FROM `conditions` WHERE `condition_entry` IN(1411,1412,1413);
INSERT INTO `conditions` 
(`condition_entry`, `type`, `value1`, `value2`) VALUES
-- 71			-- Quest ID 11081 NOT Taken AND NOT Rewarded
-- 966			-- Quest 11075 rewarded
(1411, 5, 1015, 4),  	-- Reputation with Faction 1015 is friendly or higher
(1412, -1, 71, 966),	-- AND
(1413, -1, 1411, 1412); -- AND
