...
-- ----------------------------
-- Grok (Entry: 22940)
UPDATE gossip_menu SET condition_id = 1409 WHERE entry = 8619 AND text_id = 10879; -- Quest 11000 Rewarded
...
INSERT INTO `gossip_menu` (`entry`, `text_id`, `script_id`, `condition_id`) VALUES 
(8657, 10877, 0, 0),
(8657, 10878, 0, 1409); -- Quest 11000 Rewarded
...
INSERT INTO `gossip_menu` (`entry`, `text_id`, `script_id`, `condition_id`) VALUES 
(8620, 10800, 0, 0),
(8620, 10860, 0, 1409); -- Quest 11000 Rewarded
