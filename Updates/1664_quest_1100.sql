-- Add CompleteScript for q.11000 Into the Soulgrinder 
-- + some gossip fixes
...
-- ----------------------------
-- Grok (Entry: 22940)
DELETE FROM `conditions` WHERE `condition_entry`=1543;
INSERT INTO `conditions` (`condition_entry`, `type`, `value1`, `value2`) VALUES 
(1543, 8, 11000, 0); -- Quest 11000 Rewarded

UPDATE gossip_menu SET condition_id = 1543 WHERE entry = 8619 AND text_id = 10879; -- Quest 11000 Rewarded
...
INSERT INTO `gossip_menu` (`entry`, `text_id`, `script_id`, `condition_id`) VALUES 
(8657, 10877, 0, 0),
(8657, 10878, 0, 1543); -- Quest 11000 Rewarded
...
INSERT INTO `gossip_menu` (`entry`, `text_id`, `script_id`, `condition_id`) VALUES 
(8620, 10800, 0, 0),
(8620, 10860, 0, 1543); -- Quest 11000 Rewarded
...
(39914,0,22912,0); -- target for Soulgrinder Ghost spell
