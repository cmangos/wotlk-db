...
-- those that dont exist wont be updated, others were ported with same id, just named differently
...
-- DIFF, Typo in wotlkmangos due to overwrite!
UPDATE `creature_spawn_data_template` SET `Name` = 'Servant of the Hand (15080) - RelayScript (29)' WHERE `Entry` = 9998; -- - Relayid 29
UPDATE `creature_spawn_data_template` SET `Name` = 'Servant of the Hand (15080) - RelayScript (28)' WHERE `Entry` = 9999; -- Defias Rioter - RelayScript (30510)
