...
(9566,1,0,0,0,0,0,6,2000000819,0,0,0,0,0,0,0,''),
...
(9566,5,0,0,0,17189,50,7,2000000820,0,0,0,0,0,0,0,'17189 text'),
(9566,6,26,0,0,17189,50,0,0,0,0,0,0,0,0,0,'');
UPDATE quest_template SET StartScript = 9566 WHERE entry = 9566;
DELETE FROM db_script_string WHERE entry IN (2000000819,2000000820);
INSERT INTO db_script_string (entry, content_default, sound, type, language, emote, comment) VALUES 
(2000000819,'The sound of footsteps shuffling echo throughout cave.',0,2,0,0,NULL),
(2000000820,'You stay away from crystals! Die now!',0,0,0,0,NULL);
