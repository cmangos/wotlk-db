...
-- Barak Kodobane 3394
UPDATE creature SET spawndist = 5, MovementType = 1 WHERE guid = 13988;
...
(13157,4316,1,1,1,-957.8265,-1943.9536,92.878586,4.17914,300,300,0,0);
...
DELETE FROM creature_linking WHERE guid IN (20858,13157); -- old linking removed
...
DELETE FROM creature_linking WHERE guid IN (20856); -- old linking removed
-- moved to spawn_groups
...
DELETE FROM creature_linking WHERE guid IN (20868); -- old linking removed
-- moved to spawn_groups
...
DELETE FROM creature_linking WHERE guid IN (20869); -- old linking removed
-- moved to spawn_groups
...
DELETE FROM creature_linking WHERE guid IN (20866); -- old linking removed
-- moved to spawn_groups
...
DELETE FROM creature_linking WHERE guid IN (20864); -- old linking removed
-- moved to spawn_groups
...
DELETE FROM creature_linking WHERE guid IN (20855); -- old linking removed
-- moved to spawn_groups
...
DELETE FROM creature_linking WHERE guid IN (20865); -- old linking removed
-- moved to spawn_groups
...
INSERT INTO creature (guid, id, map, spawnmask, phasemask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) values
(13233,4316,1,1,1,-1561.5756,-2973.4485,89.358086,0,300,300,0,0), -- Kolkar Packhound 4316
(13234,3275,1,1,1,-1561.5756,-2973.4485,89.358086,0,300,300,0,0); -- Kolkar Marauder 3275
...
DELETE FROM creature_linking WHERE guid IN (20867); -- old linking removed
-- moved to spawn_groups
...
DELETE FROM creature_linking WHERE guid IN (20857); -- old linking removed
-- moved to spawn_groups
...
DELETE FROM creature_linking WHERE guid IN (20863); -- old linking removed
-- moved to spawn_groups
...
INSERT INTO creature (guid, id, map, spawnmask, phasemask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) values
(13230,3274,1,1,1,-1450.9772,-3014.935,93.416664,0,300,300,0,0),
(13231,4316,1,1,1,-1450.9772,-3014.935,93.416664,0,300,300,0,0);
-- moved to spawn_groups
...
INSERT INTO creature (guid, id, map, spawnmask, phasemask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) values
(13232,3273,1,1,1,213.05031,-1803.9269,95.473465,0,300,300,0,4); -- linear wps
...
-- Brokespear 5838
UPDATE creature_template SET EquipmentTemplateId = 61 WHERE entry IN (5838); -- /0 - 2023/ /1 - 0/ /2 - 5870/
-- missing added
...
INSERT INTO creature (guid, id, map, spawnmask, phasemask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) values
(13235,5838,1,1,1,-1397.823,-2750.0356,91.77308,2.042035102844238281,7200,10800,0,0);
-- moved to spawn_groups
...
INSERT INTO creature (guid, id, map, spawnmask, phasemask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) values
(13236,5837,1,1,1,-232.9636,-1656.993,91.776634,5.951572895050048828,5400,9000,0,0);
-- moved to spawn_groups
