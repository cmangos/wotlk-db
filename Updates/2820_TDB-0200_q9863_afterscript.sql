...
(9863,0,1,0,0,0,0,2000019027,0,0,0,0,0,0,'Farseer Kurkush - %s places the Murkblood idols atop the Lightning stone and invokes the spirits.',0,0,0,0),
(9863,2719,0,15,32127,0,0,0,0,0,0,0,0,0,'Farseer Kurkush - Cast Call to Lightning',0,0,0,0);

-- Add text
DELETE FROM `dbscript_string` WHERE `entry`=2000019027;
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`, `comment`, `broadcast_text_id`) VALUES 
(2000019027, '%s places the Murkblood idols atop the Lightning stone and invokes the spirits.', 0, 2, 1, 0, 'Farseer Kurkush (Entry: 18066)',14998);
