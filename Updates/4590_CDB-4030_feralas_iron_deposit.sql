-- WotlkDB static spawn
DELETE FROM `gameobject` WHERE `guid` IN (6199,6249,6423,6443,6460,6495,6584,6588,6640,6671,50024,50162,50164,50165,50166,120423,120439);
