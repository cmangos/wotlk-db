...
UPDATE `gameobject` SET `position_x` = 2851.745, `position_y` = -1403.158, `position_z` = 148.9066, `orientation` = 0.523598 WHERE `guid` = 53164;
...
(20, 153468, 0, 1, 2989.212, -1601.668, 184.4491, 2.495821, 0, 0, 0, 0, 86400, 86400, 100, 1);

DELETE FROM `pool_gameobject` WHERE `guid` IN (5,6);
INSERT INTO `pool_gameobject` (`guid`, `pool_entry`, `chance`, `description`) VALUES
(5, 39934, 0, 'Western Plaguelands - Large Mithril Bound Chest (153468)'),
(20, 39934, 0, 'Western Plaguelands - Large Mithril Bound Chest (153468)');
