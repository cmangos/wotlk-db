...
UPDATE `creature_template` SET `SpeedWalk` = 1, `MeleeBaseAttackTime` = 2000, `Faction` = 74, `MinLevel`='51', `MaxLevel`='52', EquipmentTemplateId = 2536 WHERE `entry` = 6647;
UPDATE `creature_template` SET `SpeedWalk` = 1, `MeleeBaseAttackTime` = 2000, `Faction` = 74, `MinLootGold`='0', `MaxLootGold`='0', `DamageMultiplier`='1.0', EquipmentTemplateId = 10 WHERE `entry` = 8578; -- (55 class 8 66-92dmg)
