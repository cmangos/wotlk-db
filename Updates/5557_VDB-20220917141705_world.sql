...
(556, 8, 1141, 0, 0, 0, 0, ''), -- TDB - 812
(557, 9, 1141, 0, 0, 0, 0, ''), -- TDB - 813
(558, -2, 557, 556, 0, 0, 0, ''); -- TDB - 814
...
(256200, 0, 15, 7733, 0, 0, 553, 'Gubber Blump  - Teach Fishing', 0), -- 7620/7733
(256200, 0, 0, 0, 0, 5531, 0, 'Gubber Blump  - Say Text', 0);

-- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

-- Correct Gossip For Sputtervalve - renumber
UPDATE `gossip_menu_option` SET `action_menu_id` = 1381 WHERE `menu_id` = 21 AND `id` = 1; -- 20024
UPDATE `gossip_menu` SET `entry` = 1381 WHERE `entry` = 20024;
...
UPDATE `gossip_menu_option` SET `condition_id` = 102 WHERE `menu_id` = 1403 AND `id` = 0; -- I am here for training. -> Druid (Player ClassMask: 1024)
