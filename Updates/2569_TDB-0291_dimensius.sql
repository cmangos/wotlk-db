...
UPDATE conditions SET value2=950, comments='(Quest ID 10439 Taken AND Source of Condition''s Last Waypoint == 0)' WHERE condition_entry=970;
DELETE FROM conditions WHERE condition_entry=950;
INSERT INTO conditions (condition_entry, type, value1, value2, comments) VALUES
('950', '33', '0', '0', 'Source of Condition\'s Last Waypoint == 0');
