...
DELETE FROM gameobject WHERE guid IN (5198,69,5517);
...
(69, 2178, 0, 1, -8845.385, 922.9111, 101.7831, 2.068215, 0, 0, 0.8594065, 0.5112929, 120, 120, 0, 0);
...
DELETE FROM gameobject WHERE guid IN (71,73,4972);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(71, 2131, 0, 1, -8508.362, 659.8925, 99.9641, 0.6021398, 0, 0, 0.2965422, 0.9550198, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(73, 2186, 0, 1, -8726.224, 892.5807, 100.5635, 3.831001, 0, 0, -0.9411755, 0.3379182, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(76, 28045, 0, 1, -8529.818, 495.8429, 111.2916, 3.813545, 0, 0, -0.9440889, 0.3296909, 120, 120, 0, 0),
