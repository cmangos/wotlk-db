...
(376,4463,0,1,1,-9719.513,-3167.964,59.06486,5.32325,300,300,0,0);
-- shared spawns
DELETE FROM creature_spawn_entry WHERE guid IN (376,6728);
INSERT INTO creature_spawn_entry (guid,entry) VALUES
-- Blackrock Grunt 440 & Blackrock Summoner 4463
(376,440),(376,4463);
UPDATE creature SET id = 0 WHERE guid IN (376,6728);
...
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) VALUES
(518,437,0,1,1,-9642.596,-3169.3962,48.83993,0,300,300,0,0); -- part of formation
...
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) VALUES
(724,485,0,1,1,-9573.077,-3297.274,47.194336,0,300,300,0,2);
