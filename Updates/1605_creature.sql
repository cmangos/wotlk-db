...
UPDATE creature SET DeathState = 0, MovementType = 0 WHERE guid IN (110369,110370,110378,110379,110380,110381,110382,110383,110384,110386,110389,110390);
...
UPDATE creature SET DeathState = 0, MovementType = 0 WHERE guid IN (110502,110514,110515,110516,110520,110527,110528,110529,110530);
