...
-- Circle of Prophecy
( 14124, 181782, 530, 1,1,-3398.4, -12407.2, 18.8326, 1.570796, 0, 0, 0.7071066, 0.7071069, -8, 255, 1), -- must be spawned only for 8 secs
-- Vision of the Future
( 14127, 181755, 530, 1,1,-3398.663, -12407.24, 22.16492, 6.003934, 0, 0, -0.1391726, 0.9902682, -10, 255, 1); -- must be spawned only for 10 secs
-- Correct Size
...
(10797,8,0,0,0,0,0,0,2000000824,0,0,0,0,0,0,0,'');
-- EVENT 10799
...
-- missing texts added
DELETE FROM db_script_string WHERE entry BETWEEN 2000000824 AND 2000000826;
INSERT INTO db_script_string (entry, content_default, sound, type, language, emote, comment) VALUES
(2000000824,'[Furbolg] What could it mean?',0,0,0,0,NULL),
