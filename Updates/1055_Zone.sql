...
DELETE FROM creature_addon WHERE guid IN (12716,134679);
DELETE FROM creature_movement WHERE id IN (12716,134679);
DELETE FROM game_event_creature WHERE guid IN (12716,134679);
DELETE FROM game_event_creature_data WHERE guid IN (12716,134679);
DELETE FROM creature_battleground WHERE guid IN (12716,134679);
DELETE FROM creature_linking WHERE guid IN (12716,134679)
 OR master_guid IN (12716,134679);
DELETE FROM creature WHERE guid IN (12716,134679);
INSERT INTO creature (guid, id, map, spawnMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES 
(12716, 20025, 1, 1, 0, 0, -8689.938, -4213.349, -207.8566, 3.822271, 300, 300, 0, 0, 9489, 0, 0, 0),
(134679, 20025, 1, 1, 0, 0, -8645.533, -4219.853, -207.2871, 4.974188, 300, 300, 0, 0, 9489, 0, 0, 0);
...
(1993301,0,0,0,0,0,0,0,0,2000001349,0,0,0,0,0,0,0,'Nozari - say 1'),
(1993301,4,0,0,0,0,19932,10,0,2000001350,0,0,0,0,0,0,0,'Andormu - say 1'),
(1993301,10,0,0,0,0,0,0,0,2000001351,0,0,0,0,0,0,0,'Nozari - say 2'),
(1993301,14,0,0,0,0,19932,10,0,2000001352,0,0,0,0,0,0,0,'Andormu - say 2'),
(1993301,21,0,0,0,0,19932,10,0,2000001353,0,0,0,0,0,0,0,'Andormu - say 3'),
(1993301,26,0,0,0,0,0,0,0,2000001354,0,0,0,0,0,0,0,'Nozari - say 3'),
(1993301,34,0,0,0,0,19932,10,0,2000001355,0,0,0,0,0,0,0,'Andormu - say 4'),
(1993301,39,0,0,0,0,19932,10,0,2000001356,0,0,0,0,0,0,0,'Andormu - say 5'),
(1993301,45,0,0,0,0,0,0,0,2000001357,0,0,0,0,0,0,0,'Nozari - say 4'),
(1993301,49,0,0,0,0,19932,10,0,2000001358,0,0,0,0,0,0,0,'Andormu - say 6'),
(1993301,60,0,0,0,0,0,0,0,2000005706,0,0,0,0,0,0,0,'Andormu - say 7'); -- pre-existing "%s nods." 

DELETE FROM dbscript_string WHERE entry BETWEEN 2000001349 AND 2000001358;
INSERT INTO dbscript_string (entry, content_default, emote) VALUES
(2000001349,'Fascinating. What is it, Andormu?',6),
(2000001350,'Something very, very disturbing. We''re starting to see more of them across the timeways.',1),
(2000001351,'Hrm, are they tampering with timeways?',6),
(2000001352,'Nozari, I\'m not talking about a greedy wizard looking to improve his station in life by making a small adjustment to the past.',274),
(2000001353,'These beings aren\'t giving themselves the winning numbers for the Stormwind lottery, dear.',1),
(2000001354,'I hate it when you speak to me in that manner. I am your equal in every way, brother. Remember that the next time you are trapped amidst a temporal vortex, crying for help.',1),
(2000001355,'My apologies, Nozari. I have been a bit \'on edge\' as of late. These creatures are attempting to alter the timeways.',273),
(2000001356,'You do recall the last time that this occurred, yes? Let us hope that the master need not be involved.',1),
(2000001357,'Shall we?',6),
(2000001358,'Absolutely not. We must not place ourselves at risk. With the master away, we are all that is in place to keep the stream intact. Others are due to arrive any moment now. Heroes and adventurers from Azeroth...',1);
...
(1995002,2,0,0,0,0,0,0,0,2000001359,0,0,0,0,0,0,0,'Custodian of Time - say 1'),
(1995002,3,15,34786,0,0,20053,10,1,0,0,0,0,0,0,0,0,'Custodian of Time - cast Temporal Analysis on Lordaeron Sentry Specimen'),
(1995002,7,0,0,0,0,0,0,0,2000001360,2000001361,2000001362,2000001363,0,0,0,0,'Custodian of Time - random say 2');
...
DELETE FROM creature_addon WHERE guid IN (134680);
DELETE FROM creature_movement WHERE id IN (134680);
DELETE FROM game_event_creature WHERE guid IN (134680);
DELETE FROM game_event_creature_data WHERE guid IN (134680);
DELETE FROM creature_battleground WHERE guid IN (134680);
DELETE FROM creature_linking WHERE guid IN (134680)
 OR master_guid IN (134680);
DELETE FROM creature WHERE guid IN (134680);
INSERT INTO creature (guid, id, map, spawnMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES 
(134680, 19950, 1, 1, 0, 0, -8425.29, -4193.42, -207.737, 2.45749, 600, 600, 0, 0, 6986, 100, 0, 0);

UPDATE creature SET orientation = 2.45749 WHERE guid = 23459;
DELETE FROM creature_linking WHERE guid = 134680;
INSERT INTO creature_linking (guid, master_guid, flag) VALUES
(134680,23459,512); -- follow

DELETE FROM dbscript_string WHERE entry IN (2000001359,2000001360,2000001361,2000001362,2000001363);
INSERT INTO dbscript_string (entry, content_default, emote, type) VALUES
(2000001359,'%s examines the specimen.',0,2),
(2000001360,'I can''t get a reading... Something is interfering...',1,0),
(2000001361,'This specimen is fading from existence. Something or someone is altering the timeway.',1,0),
(2000001362,'We must dispatch another watcher. Balance must be maintained...',1,0),
(2000001363,'Have the Scale of Sands been made aware?',6,0);
...
(@GUID,19918,1,1,0,0,-8466.481,-4224.501,-81.56217,0,30,30,0,0,6986,0,0,2);
DELETE FROM creature_movement WHERE id = @GUID;
INSERT INTO creature_movement (id,point,position_x,position_y,position_z,orientation,waittime,script_id) VALUES
...
SET @GUID:=23440;
REPLACE INTO creature (guid,id,map,spawnMask,modelid,equipment_id,position_x,position_y,position_z,orientation,spawntimesecsmin,spawntimesecsmax,spawndist,currentwaypoint,curhealth,curmana,DeathState,MovementType) VALUES 
(@GUID,19918,1,1,0,0,-8713.636,-4326.533,-60.83437,0,30,30,0,0,6986,0,0,2);
DELETE FROM creature_movement WHERE id = @GUID;
INSERT INTO creature_movement (id,point,position_x,position_y,position_z,orientation,waittime,script_id) VALUES
...
SET @GUID:=23439;
REPLACE INTO creature (guid,id,map,spawnMask,modelid,equipment_id,position_x,position_y,position_z,orientation,spawntimesecsmin,spawntimesecsmax,spawndist,currentwaypoint,curhealth,curmana,DeathState,MovementType) VALUES 
(@GUID,19918,1,1,0,0,-8345.674,-4449.603,-91.66009,0,30,30,0,0,6986,0,0,2);
DELETE FROM creature_movement WHERE id = @GUID;
INSERT INTO creature_movement (id,point,position_x,position_y,position_z,orientation,waittime,script_id) VALUES
...
SET @GUID:=23438;
REPLACE INTO creature (guid,id,map,spawnMask,modelid,equipment_id,position_x,position_y,position_z,orientation,spawntimesecsmin,spawntimesecsmax,spawndist,currentwaypoint,curhealth,curmana,DeathState,MovementType) VALUES 
(@GUID,19918,1,1,0,0,-8339.216,-4462.258,-98.89476,0,30,30,0,0,6986,0,0,2);
DELETE FROM creature_movement WHERE id = @GUID;
INSERT INTO creature_movement (id,point,position_x,position_y,position_z,orientation,waittime,script_id) VALUES
...
SET @GUID:=23436;
REPLACE INTO creature (guid,id,map,spawnMask,modelid,equipment_id,position_x,position_y,position_z,orientation,spawntimesecsmin,spawntimesecsmax,spawndist,currentwaypoint,curhealth,curmana,DeathState,MovementType) VALUES 
(@GUID,19918,1,1,0,0,-8336.925,-4462.465,-99.65054,0,30,30,0,0,6986,0,0,2);
DELETE FROM creature_movement WHERE id = @GUID;
INSERT INTO creature_movement (id,point,position_x,position_y,position_z,orientation,waittime,script_id) VALUES
...
SET @GUID:=23437;
REPLACE INTO creature (guid,id,map,spawnMask,modelid,equipment_id,position_x,position_y,position_z,orientation,spawntimesecsmin,spawntimesecsmax,spawndist,currentwaypoint,curhealth,curmana,DeathState,MovementType) VALUES 
(@GUID,19918,1,1,0,0,-8332,-4460.768,-98.79179,0,30,30,0,0,6986,0,0,2);
DELETE FROM creature_movement WHERE id = @GUID;
INSERT INTO creature_movement (id,point,position_x,position_y,position_z,orientation,waittime,script_id) VALUES
