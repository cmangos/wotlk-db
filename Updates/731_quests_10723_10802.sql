...
(21046,31754,-50,0,1,1,0,''),
(21047,31754,-45,0,1,1,0,''),
(21048,31754,-5,0,1,1,0,'');

DELETE FROM db_script_string WHERE entry BETWEEN 2000001077 AND 2000001079;
INSERT INTO db_script_string (entry, content_default, sound, type, language, emote, comment) VALUES
(2000001077,'Who dares defile the altar of Gorgrom the Dragon-Eater?',0,1,0,0,NULL),
(2000001078,'I will crush it and flay it and eat its meat and crack its bones one by one when I am done.',0,1,0,0,NULL),
(2000001079,'Misha lets out a loud roar as she rakes her claws against the gronn''s altar.',0,2,0,0,NULL);
...
(185295,8,'Gorgrom\'s Corpse',1450,20);

DELETE FROM gameobject WHERE id = 185295; -- add gameobject, respawned by script
INSERT INTO gameobject (guid,id,map,spawnMask,phaseMask,position_x,position_y,position_z,orientation,rotation0,rotation1,rotation2,rotation3,spawntimesecs,animprogress,state) VALUES
(93926,185295,530,1,1,3608.252,7180.321777,140.029190,5.407311,0,0,0,0,-60,255,1);
...
(14400,1,10,10204,30000,0,0,8,0,0,0,0,3605.5,7186.44,141.12,5.444561,'Gorgrom - Misha spawn'),
(14400,3,10,21514,70000,0,0,8,0,0,0,0,3624.955556,7165.361328,141.484894,2.24,'Gorgrom - Gorgrom spawn'),
(14536,3,10,21514,70000,0,0,8,0,0,0,0,3624.955556,7165.361328,141.484894,2.24,'Gorgrom - Gorgrom spawn'),
...
(14400,3,0,2000001079,10204,40,0,'Gorgrom - Misha SAY 1'),
(14536,4.5,0,2000001077,21514,40,0,'Gorgrom - Gorgrom SAY 1'),
(14400,4.5,0,2000001077,21514,40,0,'Gorgrom - Gorgrom SAY 1'),
(14536,7,0,2000001078,21514,40,0,'Gorgrom - Gorgrom SAY 2'),
(14400,7,0,2000001078,21514,40,0,'Gorgrom - Gorgrom SAY 2');
...
(14400,11,9,93926,60,'Gorgrom - RESPAWN GAMEOBJECT Gorgroms corpse'),
(14536,11,9,93926,60,'Gorgrom - RESPAWN GAMEOBJECT Gorgroms corpse');
...
(14400,12,15,38763,21514,40,12,'Gorgrom - CAST SPELL Suicide'),
(14536,12,15,38763,21514,40,12,'Gorgrom - CAST SPELL Suicide');
INSERT INTO dbscripts_on_event(id,delay,command,datalong,buddy_entry,search_radius,data_flags,comments) VALUES
(14400,12,18,15000,10204,40,4,'Gorgrom - Misha DESPAWN');
-- need core support (summons despawn ~ 10 secs after death (BUG))
