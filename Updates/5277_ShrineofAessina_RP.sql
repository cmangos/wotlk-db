...
DELETE FROM creature_movement WHERE Id=33027;
-- missing equipment added
DELETE FROM creature_equip_template WHERE entry IN (2543);
INSERT INTO creature_equip_template (entry, equipentry1, equipentry2, equipentry3) VALUES
(2543, 12247, 0, 5260);
UPDATE creature_template SET Faction = 80, UnitFlags = 0, EquipmentTemplateId = 2543, MovementType = 2 WHERE Entry = 24738; -- 1 - 12247, 2 - 0, 3 - 5260
...
UPDATE creature_template SET EquipmentTemplateId = 326, MovementType = 0 WHERE Entry = 24737; -- wps set by script , equip 1 - 21573
...
UPDATE creature_template SET MovementType = 0 WHERE Entry = 24735;
...
DELETE FROM creature_movement WHERE Id=32943;
UPDATE creature_template SET MovementType = 0 WHERE Entry = 24734;
