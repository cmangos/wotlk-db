...
(10362, 4, 0, 0, 0, 0, 17000, 50, 0, 2000001369, 0, 0, 0, 0, 0, 0, 0, 'Aggonis Say'),
...
DELETE FROM dbscript_string WHERE entry = 2000001369;
INSERT INTO dbscript_string (entry, content_default, sound, type, emote, comment) VALUES
(2000001369,'Fools!  You seek to abjure my father\'s presence?  Death awaits you, mortals!',0,0,0,'17000');
