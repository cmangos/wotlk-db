...
REPLACE INTO `creature_addon` (`guid`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `auras`) VALUES
-- Wretched Devourer
...
REPLACE INTO `creature_addon` (`guid`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `auras`) VALUES
...
REPLACE INTO `creature_template_addon` (`entry`, `b2_0_sheath`, `b2_1_pvp_state`) VALUES
...
UPDATE `creature_movement` SET `scriptid` = 5 WHERE `id` IN (5300851,5300852,5300853,5300854,5300855,5300856) AND `point` = 1;
...
UPDATE `creature_template_addon` SET `b2_0_sheath` = 1, `b2_1_pvp_state` = 16, `emote` = 233 WHERE `entry` = 25046;
...
REPLACE INTO `creature_template_addon` (`entry`, `b2_0_sheath`, `b2_1_pvp_state`, `auras`) VALUES (25158, 1, 16, NULL);
...
REPLACE INTO `creature_template_addon` (`entry`, `b2_0_sheath`, `b2_1_pvp_state`, `auras`) VALUES (25160, 1, 16, '47127');
