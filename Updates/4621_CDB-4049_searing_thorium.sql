...
DELETE FROM `pool_gameobject` WHERE `guid` BETWEEN 76283 AND 76287;
DELETE FROM `gameobject` WHERE `guid` BETWEEN 76283 AND 76287;
DELETE FROM `pool_pool` WHERE `pool_id` BETWEEN 6112 AND 6112;
DELETE FROM `pool_template` WHERE `entry` BETWEEN 6112 AND 6112;
