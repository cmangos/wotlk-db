...
`Variable_1` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Variable_2` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Variable_3` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Variable_4` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Variable_5` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Variable_6` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Variable_7` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Op_0` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Op_1` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Op_2` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Op_3` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Op_4` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Op_5` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Op_6` INT(11) UNSIGNED NOT NULL DEFAULT '0',
`Op_7` INT(11) UNSIGNED NOT NULL DEFAULT '0',
