...
(18653,1,-1609.1764,5299.9365,-38.582882,480000,0,0.54),
(18653,2,-1616.1292,5301.4927,-40.20918,0,0,100),
(18653,3,-1618.9323,5305.5425,-40.20918,4000,1865301,100),
(18653,4,-1618.9323,5305.5425,-40.20918,3000,1865302,0.42);
...
(1865301,1000,0,0,0,0,0,2000019021,0,0,0,18652,20,0,'Zahlia - Don''t go too far away Seth.  You know mommy doesn''t like it when she can''t hear you.',0,0,0,0),
(1865302,1000,0,0,0,0,0,2000019022,0,0,0,0,0,0,'Seth - Coming, momma!',0,0,0,0);

-- Add texts
DELETE FROM `dbscript_string` WHERE `entry` BETWEEN 2000019021 AND 2000019022;
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`, `comment`, `broadcast_text_id`) VALUES 
(2000019021, 'Don''t go too far away Seth.  You know mommy doesn''t like it when she can''t hear you.', 0, 0, 0, 0, 'Zahlia (Entry: 18652)',15634),
(2000019022, 'Coming, momma!', 0, 0, 0, 0, 'Seth (Entry: 18653)',15635);
