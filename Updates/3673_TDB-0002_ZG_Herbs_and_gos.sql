...
REPLACE INTO `gameobject_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `mincountOrRef`, `maxcount`, `condition_id`, `comments`) VALUES
(13965, 11514, 15, 1, 3, 1480, 'Fel Creep'); -- 50% befor (condition 1480 instead of 1987)
...
REPLACE INTO `gameobject_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `mincountOrRef`, `maxcount`, `condition_id`, `comments`) VALUES
(13967, 11514, 15, 1, 3, 1480, 'Fel Creep'); -- 50% befor
...
REPLACE INTO `gameobject_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `mincountOrRef`, `maxcount`, `condition_id`, `comments`) VALUES
(13968, 11514, 15, 1, 3, 1480, 'Fel Creep'); -- 50% befor
...
REPLACE INTO `gameobject_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `mincountOrRef`, `maxcount`, `condition_id`, `comments`) VALUES
(13969, 11514, 15, 1, 3, 1480, 'Fel Creep'); -- 50% befor
...
DELETE FROM `reference_loot_template` WHERE `entry` = 12011 AND `item` = 24401; -- Unidentified Plant Parts only in OUTLAND
REPLACE INTO `gameobject_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `mincountOrRef`, `maxcount`, `condition_id`, `comments`) VALUES
(19630, 24401, 30, 1, 1, 0, 'Unidentified Plant Parts'); -- 7% 1-1 befor in 12011
...
-- 17259	18335	0.3	0	1	1	0	Pristine Black Diamond (nope...)
