...
192312,192299,192292,192308,192309,192310,192253,192252,192239,192327,192328,192330,192307,192306,192287,192286,193162,193165,193163,193164,193129,193136,193128,193132,193134,193135,193138,
193137,193133,193131,193130,192834,193124,192829,131372,131373);
...
DELETE FROM creature WHERE guid IN (76304,76305,76306,76307,76308,76309,76310,76311,76312,76313,76314,77761,77762,77763,77853,77867,77868,77869,77870,77871);
INSERT INTO creature (guid, id, map, spawnmask, phasemask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) values
...
77846,77847,77848,77849,77850,77851,77852,77872,78189,78190,78191,78192,78193,78194,78195,78196,78197,78198);
INSERT INTO creature (guid, id, map, spawnmask, phasemask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) values
