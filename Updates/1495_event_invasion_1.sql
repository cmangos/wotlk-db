...
DELETE FROM game_event WHERE entry = 13; -- Elemental Invasions event removed
DELETE FROM game_event WHERE entry = 200;
INSERT INTO game_event VALUES
(200, '2006-01-01 00:00:00', '2030-12-31 23:59:00', 4320, 2160, 0, 0, 0, 'Elemental Invasion: Fire');

-- ----------------------------------------
-- Elemental Rift from which the NPCs spawn
-- ----------------------------------------
DELETE FROM gameobject WHERE guid IN (60146,60148,60149,60151,60152,60153);
DELETE FROM game_event_gameobject WHERE guid IN (60146,60148,60149,60151,60152,60153);
DELETE FROM gameobject_battleground WHERE guid IN (60146,60148,60149,60151,60152,60153);
INSERT INTO gameobject (guid, id, map, spawnMask, phaseMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(60146, 179666, 1, 1, 1, -7105.06, -1550.73, -272.101, 0, 0, 0, 0, 1, 300, 300, 0, 1),                        -- Fire Elemental Rifts
(60148, 179666, 1, 1, 1, -7185.73, -1108.07, -271.805, 0.471239, 0, 0, 0.233445, 0.97237, 300, 300, 0, 1),
(60149, 179666, 1, 1, 1, -7331.47, -1196.34, -265.41, 2.58309, 0, 0, 0.961262, 0.275636, 300, 300, 0, 1),
(60151, 179666, 1, 1, 1, -7347.25, -1334.56, -263.032, -2.9147, 0, 0, -0.993572, 0.113203, 300, 300, 0, 1),
(60152, 179666, 1, 1, 1, -7340.23, -1488.26, -257.98, 0.663225, 0, 0, 0.325568, 0.945519, 300, 300, 0, 1),
(60153, 179666, 1, 1, 1, -7007.57, -1393.05, -262.891, 2.67035, 0, 0, 0.972369, 0.233447, 300, 300, 0, 1);
...
-- Actual spawns
DELETE FROM creature WHERE guid IN (98028,102258,102259,102261);
DELETE FROM creature_addon WHERE guid IN (98028,102258,102259,102261);
DELETE FROM creature_movement WHERE id IN (98028,102258,102259,102261);
DELETE FROM game_event_creature WHERE guid IN (98028,102258,102259,102261);
DELETE FROM game_event_creature_data WHERE guid IN (98028,102258,102259,102261);
DELETE FROM creature_battleground WHERE guid IN (98028,102258,102259,102261);
DELETE FROM creature_linking WHERE guid IN (98028,102258,102259,102261) 
OR master_guid IN (98028,102258,102259,102261);
INSERT INTO creature (guid, id, map, spawnmask, phasemask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
(98028,  14461,1,1,1,0,0,-7153.77, -1085.68, -272.045, 2.80859, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 14355, 0, 0, 2),
(102258, 14460,1,1,1,0,0,-7143.03, -1088.31, -271.974, 2.89342, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 2533, 0, 0, 0),
(102259, 14460,1,1,1,0,0,-7145.11, -1080.19, -272.101, 2.89342, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 2533, 0, 0, 0),
(102261, 14460,1,1,1,0,0,-7148.78, -1094.69, -269.897, 2.89342, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 2533, 0, 0, 0);

DELETE FROM creature_linking WHERE master_guid = 98028;
