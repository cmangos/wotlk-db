...
-- (55466,1,31,0,20,0,33001,20,0x800,0,0,0,0,0,0,0,0,'search for string id = 33001 - terminate if not found'), -- fix this - otherwise he fires script every 8secs (req. core fix)
