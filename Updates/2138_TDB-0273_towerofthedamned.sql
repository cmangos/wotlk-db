...
(16471, 1, 'Ghostlands - Eye of Dar''Khan/Wailer 1'),
(16472, 1, 'Ghostlands - Eye of Dar''Khan/Wailer 2');

DELETE FROM `pool_creature` WHERE `pool_entry` IN (16471, 16472);
INSERT INTO `pool_creature` VALUES 
(82897, 16471, 0, 'Wailer 1'),
(82937, 16472, 0, 'Wailer 2'),
(85744, 16471, 0, "Eye of Dar''Khan 1"),
(85745, 16472, 0, "Eye of Dar''Khan 2");
