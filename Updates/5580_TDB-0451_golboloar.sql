...
REPLACE INTO `pool_gameobject` (`guid`, `pool_entry`, `chance`, `description`) SELECT `guid`, 999, 0, 'Dun Morogh - Earthroot' FROM `gameobject` WHERE `guid` BETWEEN 170001 AND 170003;
