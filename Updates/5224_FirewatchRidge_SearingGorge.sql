...
(381,5860,0,1,1,-6487.05,-904.107,324.309,0,300,300,3,1),
(726,5860,0,1,1,-6640.393,-808.46027,244.77988,0,300,300,0,4); -- linear
...
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, MovementType) VALUES
(725,5862,0,1,1,-6479.038,-947.91644,334.47287,0,300,300,5,1);
...
-- Muck Splash 8837
UPDATE creature SET spawndist = 5, MovementType = 1 WHERE guid IN (5625,5803,5854,5856);
...
DELETE FROM creature_movement WHERE Id IN (5862,5810,5853,5852);
INSERT INTO creature_movement (id, point, positionx, positiony, positionz, orientation, waittime, scriptid) VALUES
-- 5862
