...
CREATE TABLE tmp_creature (SELECT guid, id, map FROM creature WHERE map IN (574,575));
CREATE TABLE tmp_gameobject (SELECT guid, id, map FROM gameobject WHERE map IN (574,575));
