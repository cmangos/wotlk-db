...
UPDATE npc_vendor SET Slot = 2 WHERE entry IN (2849) AND item = 7339; -- Miniscule Diamond Ring
UPDATE npc_vendor SET Slot = 3 WHERE entry IN (2849) AND item = 7340; -- Flawless Diamond Solitaire
UPDATE npc_vendor SET Slot = 4 WHERE entry IN (2849) AND item = 7341; -- Cubic Zirconia Ring
UPDATE npc_vendor SET Slot = 5 WHERE entry IN (2849) AND item = 7342; -- Silver Piffeny Band
UPDATE npc_vendor SET Slot = 6 WHERE entry IN (2849) AND item = 7337; -- The Rock
UPDATE npc_vendor SET Slot = 7 WHERE entry IN (2849) AND item = 37934; -- Noble\'s Elementium Signet
-- cloth armor
