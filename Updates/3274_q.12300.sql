...
(20530,1000,0,0,0,0,27497,100,0x04,2000029614,0,0,0,0,0,0,0,'Part of Sergeant Bonesnap 27493 EAI: buddy text');
DELETE FROM dbscript_string WHERE entry = 2000029614;
INSERT INTO dbscript_string (entry, content_default, sound, type, language, emote, comment) VALUES
(2000029614,'Stop!  Put that knife away.  You don\'t have to do... whatever they sent you to do.  You\'re not like them yet!',0,0,0,274,NULL);
