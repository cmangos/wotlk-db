...
DELETE FROM game_event_gameobject WHERE guid IN (13316,13328,13329,13330,13331,13332);
DELETE FROM gameobject_battleground WHERE guid IN (13316,13328,13329,13330,13331,13332);
DELETE FROM gameobject WHERE guid IN (13316,13328,13329,13330,13331,13332);
...
DELETE FROM `pool_template` WHERE `entry` = 40208;
INSERT INTO `pool_template` (`entry`, `max_limit`, `description`) VALUES
('40208', '2', 'The Barrens (Bael Modan) - Box of Assorted Parts Pool');

DELETE FROM `pool_gameobject` WHERE guid IN (13303,13304,13316,13328,13329,13330,13331,13332);
