...
1080062,1080063,1080064,1080065,1080066,1080067,1080068,1080069,1080070);
-- add contition to spawn_group
UPDATE spawn_group SET WorldState = 6035, Flags = 0x08 WHERE Id BETWEEN 9001 AND 9004;
DELETE FROM conditions WHERE condition_entry IN (6035,10981);
