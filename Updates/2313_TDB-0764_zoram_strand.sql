-- Zoram Strand Update
DELETE FROM `creature` WHERE `guid` IN (180004,180005);
...
(180004, 3717, 1, 1, 0, 0, 3957.799, 822.6093, 6.174583, 0.2888897, 300, 300, 5, 0, 0, 1),
(180005, 3712, 1, 1, 0, 0, 4150.745, 1043.937, 0.9877715, 4.690147, 300, 300, 5, 0, 0, 1);
