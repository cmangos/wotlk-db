...
DELETE FROM gameobject_questrelation WHERE id=180642 AND quest=8578;
...
UPDATE creature_loot_template SET condition_id = 65 WHERE item BETWEEN 21103 AND 21110; -- q.8620 'The Only Prescription' taken
