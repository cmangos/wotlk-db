...
UPDATE `creature_template` SET `MinLevel` = 54, `MaxLevel` = 55, `DifficultyEntry1` = 22749 WHERE `entry` = 13098; -- Coldmine Invader (64-65)
...
DELETE FROM `reference_loot_template` WHERE `entry` IN (24036,24047,24058,24059,24070,24071,24073,24155,14500,24156);
DELETE FROM `reference_loot_template_names` WHERE `entry` IN (24036,24047,24058,24059,24070,24071,24073,24155,14500,24156);
DELETE FROM `creature_loot_template` WHERE `mincountorref` IN (-24036,-24047,-24058,-24059,-24070,-24071,-24073,-24155,-14500,-24156);
...
-- NAXX NPCS
DELETE FROM `creature_loot_template` WHERE `mincountorref` BETWEEN -60008 AND -60000
...
DELETE FROM `reference_loot_template` WHERE `entry` IN (14500,24155,24156,44007,45000,45001,45006,45008,45009) AND `mincountOrRef` IN (-24073,-24059,-24070);
...
(24000, 'grey itemlevel 66'),
(24001, 'grey itemlevel 69'),
(24003, 'green itemlevel 90-93 lvl 60-61'),
(24004, 'blue itemlevel 85-91 lvl 60-61'),
(24005, 'green itemlevel 96-99 lvl 62-63'),
(24006, 'blue itemlevel 91-94 lvl 62-63'),
(24007, 'green itemlevel 120-105 lvl 64-65'),
(24008, 'blue itemlevel 97-100 lvl 64-65'),
(24010, 'blue itemlevel 103-106 lvl 66-67'),
(24011, 'green itemlevel 114-117 lvl 68-69'),
(24013, 'green itemlevel 120 lvl 70'),
(24014, 'blue itemlevel 109-115 lvl 70'),
(24015, 'purple itemlevel 100 lvl 70'),
(24022, 'green plate itemlevel 81-84 lvl 57-58'),
(24023, 'green plate itemlevel 87 lvl 59'),
(24024, 'grey itemlevel 50-59'),
(24035, 'Scrolls V & Super Mana / Healing Potion'),
(24066, 'green itemlevel 26-27 lvl 21-22'),
(24072, 'grey "Unkempt / Scraggy / Shoddy + Shield"'),
(24092, 'NPC LOOT - Profession (Design,Formula,Pattern,Recipe) itemlevel 69-72 - TBC NPC ONLY'),
(24093, 'NPC LOOT - Profession (Design,Pattern,Recipe,Plans,Schematic) itemlevel 73 - TBC NPC ONLY'),
(24094, 'Green Hills of Stranglethorn - Page'),
(24107, 'Ref -24066 25%'),
(24108, 'Ref -24066 50%'),
(24109, 'Ref -24066 25%'),
(24126, 'Ref -24003 25%'),
(24127, 'Ref -24005 25% & Ref -24003 50%');
