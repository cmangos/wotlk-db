...
UPDATE `creature` SET `currentwaypoint` = 0 WHERE `guid` IN (
91,	-- 14365 0
-- 6240021	35143 instance file, spawn point = first waypoint
-- 6240013	34015 instance file, spawn point = first waypoint
79768, -- 14439	0
79818, -- 14423 0
90484 -- 14438 0
);
...
-- 106013, -- 5429	1 (already correctly ported to wotlk-db)
-- 106014, -- 5429	1 (already correctly ported to wotlk-db)
-- 106029, -- 5424	1 (already correctly ported to wotlk-db)
-- 106030, -- 5426	1 (already correctly ported to wotlk-db)
-- 106031, -- 5424	1 (already correctly ported to wotlk-db)
-- 106032 -- 5426	1 (already correctly ported to wotlk-db)
);
